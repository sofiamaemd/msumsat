...
<title>Staff | Faculty & Staff | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Staff</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              <a href="../campus-life.php"><li class="option"><span class="option-text">Faculty & Staff</span></li></a>
              <a href="staff-resources.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="staff-resources/administrative-policies.php"><li class="option"><span class="option-text">Administrative Policies</span></li></a>
              <a href="staff-resources/staff-directory.php"><li class="option"><span class="option-text">Staff Directory</span></li></a>
              <a href="staff-resources/downloads.php"><li class="option"><span class="option-text">Downloads</span></li></a>

            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="staff-resources.php"><ul id="active-sbar">Overview</ul></a>
              <a href="staff-resources/administrative-policies.php"><ul>Administrative Policies</ul></a>
              <a href="staff-resources/staff-directory.php"><ul>Staff Directory</ul></a>
              <a href="staff-resources/downloads.php"><ul>Downloads</ul></a>
      ...
      <div class="col-2-con">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>Overview</h1>
            <p>
            Non-teaching employees who work in various roles and departments within an educational institution. 
            They play a vital role in supporting the overall functioning of the institution and ensuring its 
            smooth operation. Staff members encompass a wide range of positions and responsibilities, including 
            administrative, technical, support, and service roles.
            </p>
          </div>
        </div>
