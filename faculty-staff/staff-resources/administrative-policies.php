...
<title>Administrative Policies | Faculty & Staff | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="../staff.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="development-programs.php"><li class="option"><span class="option-text">Administrative Policies</span></li></a>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../staff.php"><ul>Overview</ul></a>
              <a href="administrative-policies.php"><ul id="active-sbar">Administrative Policies</ul></a>
              <a href="staff-directory.php"><ul>Staff Directory</ul></a>
