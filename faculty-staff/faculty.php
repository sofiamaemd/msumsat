...
<title>Faculty | Faculty & Staff | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Faculty</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="faculty.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="faculty-resources/development-programs.php"><li class="option"><span class="option-text">Development Programs</span></li></a>
              <a href="faculty-resources/faculty-directory.php"><li class="option"><span class="option-text">Faculty Directory</span></li></a>
              <a href="faculty-resources/downloads.php"><li class="option"><span class="option-text">Downloads</span></li></a>

            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="faculty.php"><ul id="active-sbar">Overview</ul></a>
              <a href="faculty-resources/development-programs.php"><ul>Development Programs</ul></a>
              <a href="faculty-resources/faculty-directory.php"><ul>Faculty Directory</ul></a>
              <a href="faculty-resources/downloads.php"><ul>Downloads</ul></a>
      ...
      <div class="col-2-con">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>Overview</h1>
            <p>
            Play a central role in the delivery of education, conducting research, and contributing 
            to the overall academic environment. Faculty members are highly qualified experts in their 
            respective fields who impart knowledge, mentor students, and contribute to the advancement 
            of knowledge through their research and scholarly activities.
            </p>
            <p>
            Faculty is responsible for teaching and guiding students in their academic pursuits. 
            They design and deliver courses, develop curriculum, and facilitate learning through lectures, 
            discussions, laboratory work, and other instructional methods. Faculty members bring their 
            expertise, experience, and passion for their subjects, fostering a stimulating and engaging 
            learning environment. They not only impart knowledge but also inspire critical thinking, 
            creativity, and a thirst for lifelong learning.
            </p>
          </div>
        </div>
        <div class="col-2-3" id="responsive">
          <div class="col-2-subp">
            ...
            <div class="col-3-links">
              <p><a href="../home/campus-officials/campus-overall-directory.php">Overall Directory</a></p>
