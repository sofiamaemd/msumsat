...
<title>Faculty Directory | Faculty & Staff | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="development-programs.php"><li class="option"><span class="option-text">Development Programs</span></li></a>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../faculty.php"><ul>Overview</ul></a>
              <a href="development-programs.php"><ul>Development Programs</ul></a>
              <a href="faculty-directory.php"><ul id="active-sbar">Faculty Directory</ul></a>
              <a href="downloads.php"><ul>Downloads</ul></a>
              <a href="../../faculty-staff.php"><ul id="sbar-back">« Back to Faculty & Staff</ul></a>
            </div>
      </div>
      <div class="col-2-con">
      <img id="prospectus-img-size" src="../../images/directory-img.jpg" alt="">
            ...
            <div class="slider">
                <div class="slider-wrapper">
                  <?php
                        ...
                        $result = $mysqli->query("SELECT id, fullname, position, title, comment, image FROM faculty_directory");
