...
<title>Teaching Resources | Faculty & Staff | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Teaching Resources</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="teaching-resource.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a id="link-disable"><li class="option"><span class="option-text">Academic Calendar</span></li></a>
              <a href="../academics/prospectus.php"><li class="option"><span class="option-text">Prospectus</span></li></a>
              <a id="link-disable"><li class="option"><span class="option-text">eLibrary: Local and Foreign Databases</span></li></a>
              <a id="link-disable"><li class="option"><span class="option-text">Downloads</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="teaching-resource.php"><ul id="active-sbar">Overview</ul></a>
              <a id="link-disable"><ul>Academic Calendar</ul></a>
              <a href="../academics/prospectus.php"><ul>Prospectus</ul></a>
              <a id="link-disable"><ul>eLibrary: Local and Foreign Databases</ul></a>
              <a id="link-disable"><ul>Downloads</ul></a>
