...
<title>Secondary Education | Faculty & Staff | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
              ...
              <a href="dse.php"><ul id="active-sbar">Secondary Education</ul></a>
            ...
            <div class="slider">
                ...
                <!------------------------------->  
                    <?php
                        ...
                        $result = $mysqli->query("SELECT id, fullname, position, title, comment, image FROM se_directory");
