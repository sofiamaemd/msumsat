...
<title>Humanities, Education, and Social Sciences | Faculty & Staff | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
              ...
              <a href="dhrmt.php"><ul>Hotel and Restaurant Management</ul></a>
              <a href="dhess.php"><ul id="active-sbar">Humanities, Education, & Social Sciences</ul></a>
            ...
            <div class="slider">
                ...
                <!------------------------------->  
                    <?php
                        ...
                        $result = $mysqli->query("SELECT id, fullname, position, title, comment, image FROM hess_directory");
