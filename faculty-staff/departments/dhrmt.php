...
<title>Hotel and Restaurant Management Technology | Faculty & Staff | MSU Maigo</title><meta charset="utf-8">
      ...
      <h2 class="page-header-1">Departments</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              <a href="../../faculty-staff.php"><li class="option"><span class="option-text">Faculty & Staff</span></li></a>
              <a href="../departments.php"><li class="option"><span class="option-text" >Overview</span></li></a>
              <a href="dcs.php"><li class="option"><span class="option-text" >Computer Science</span></li></a>
              <a href="det.php"><li class="option"><span class="option-text" >Engineering Technology</span></li></a>
              <a href="dhrmt.php"><li class="option"><span class="option-text" >Hotel and Restaurant Management</span></li></a>
              <a href="dhess.php"><li class="option"><span class="option-text" >Humanities, Education, & Social Sciences</span></li></a>
              <a href="dit.php"><li class="option"><span class="option-text" >Industrial Technology</span></li></a>
              <a href="dnsm.php"><li class="option"><span class="option-text" >Natural Science and Mathematics</span></li></a>
              <a href="dse.php"><li class="option"><span class="option-text" >Secondary Education</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../departments.php"><ul>Overview</ul></a>   
              <a href="dcs.php"><ul>Computer Science</ul></a>
              <a href="det.php"><ul>Engineering Technology</ul></a>
              <a href="dhrmt.php"><ul id="active-sbar">Hotel and Restaurant Management</ul></a>
              <a href="dhess.php"><ul>Humanities, Education, & Social Sciences</ul></a>
              <a href="dit.php"><ul>Industrial Technology</ul></a>
              <a href="dnsm.php"><ul>Natural Science and Mathematics</ul></a>
              <a href="dse.php"><ul>Secondary Education</ul></a>
              <a href="../../faculty-staff.php"><ul id="sbar-back">« Back to Faculty & Staff</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="prospectus-img-size" src="department-img/dhess-img.png" alt="">
            ...
            <div class="slider">
                ...
                <!------------------------------->  
                    <?php
                        ...
                        $result = $mysqli->query("SELECT id, fullname, position, title, comment, image FROM hrmt_directory");
                        if ($result && $result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<img src="../../my.Account/admin/departments/' . $row['image'] . '" alt="">';
                                echo '</div>';
                                echo '</div>';
                                echo '<div class="collapse-1-whole">';
