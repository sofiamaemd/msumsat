...
<title>Natural Science and Mathematics | Faculty & Staff | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
              ...
              <a href="dnsm.php"><ul id="active-sbar">Natural Science and Mathematics</ul></a>
              <a href="dse.php"><ul>Secondary Education</ul></a>
              <a href="../../faculty-staff.php"><ul id="sbar-back">« Back to Faculty & Staff</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="prospectus-img-size" src="department-img/dnsm-img.JPG" alt="">
            ...
            <div class="slider">
                ...
                <!------------------------------->  
                    <?php
                        ...
                        $result = $mysqli->query("SELECT id, fullname, position, title, comment, image FROM nsm_directory");
