...
<title>Senior High School | Facullty & Staff | MSU Maigo</title><meta charset="utf-8">
      ...
      <main>
        ...
        <div class="col-1-con first">
              <div class="sidebar-col">
                ...
                <a href="jhs.php"><ul>Junior High School</ul></a>
                <a href="shs.php"><ul id="active-sbar">Senior High School</ul></a>
                <a href="../../departments.php"><ul id="sbar-back">« Back to Departments</ul></a>
              </div>
        </div>
        <div class="col-2-con">
          <img id="prospectus-img-size" src="schools-img/shs-img.jpg" alt="">
          <div class="col-2-2" id="responsive">
            <div class="col-1-subp">
                <h1>Senior High School</h1>
                <p>
                  Senior High School is the last two years of secondary education in the Philippines, following the 
                  K-12 education program. It is intended to provide students with specialized knowledge and skills 
                  to prepare them for tertiary education, employment, or entrepreneurship.
                </p>
                <p>
                  Senior High School consists of two main tracks: the Academic Track and the Technical-Vocational-
                  Livelihood (TVL) Track. The Academic Track is further divided into four strands: Accountancy, 
                  Business, and Management (ABM); Humanities and Social Sciences (HUMSS); Science, Technology, 
                  Engineering, and Mathematics (STEM); and General Academic Strand (GAS). The TVL Track, on the 
                  other hand, offers specialized courses that are focused on specific skills and industries.
                </p>
                <p>
                  Senior High School aims to equip students with critical thinking, problem-solving, communication, 
                  and collaboration skills. It also provides opportunities for students to engage in community service, 
                  work immersion, and entrepreneurship activities to develop their leadership and teamwork skills.
                </p>
            </div>
          </div>
