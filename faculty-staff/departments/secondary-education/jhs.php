...
<title>Junior High School | Home | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
    <div class="body-inner-wrapper">
      <main>
        <h2 class="page-header-1">Secondary Education</h2>
          <div id="submenu" class="select-menu">
            <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
              ...
              <ul class="options">
                <a href="../../departments.php"><li class="option"><span class="option-text">Departments</span></li></a>
                <a href="../dse.php"><li class="option"><span class="option-text">Overview</span></li></a>
                <a href="jhs.php"><li class="option"><span class="option-text">Junior High School</span></li></a>
                <a href="shs.php"><li class="option"><span class="option-text">Senior High School</span></li></a>
              </ul>
          </div>
        <div class="col-1-con first">
              <div class="sidebar-col">
                <a href="../dse.php"><ul>Overview</ul></a>   
                <a href="jhs.php"><ul id="active-sbar">Junior High School</ul></a>
                <a href="shs.php"><ul>Senior High School</ul></a>
                <a href="../../departments.php"><ul id="sbar-back">« Back to Departments</ul></a>
              </div>
        </div>
        <div class="col-2-con">
          <img id="prospectus-img-size" src="schools-img/jhs-img.jpg" alt="">
          <div class="col-2-2" id="responsive">
            <div class="col-1-subp">
              <h1>Junior High School</h1>
              <p>
                Junior High School is the three-year level of secondary education in the Philippines that comes after
                elementary school and before Senior High School. It is part of the K-12 program, which was implemented 
                to enhance the quality of education in the country and make it more responsive to the needs of students 
                and the workforce.
              </p>
              <p>
                Junior High School aims to provide students with a strong foundation in academic and life skills. It 
                covers the following learning areas: English, Filipino, Mathematics, Science, Araling Panlipunan 
                (Social Studies), Technology and Livelihood Education (TLE), Music, Arts, Physical Education and 
                Health (MAPEH).
              </p>
              <p>
                The curriculum of Junior High School is designed to develop students' critical thinking, problem-
                solving, and communication skills. It also includes values education to help students develop good 
                character and social responsibility.
              </p>
              <p>
                Upon completion of Junior High School, students are expected to have a solid foundation in the core 
                academic subjects and be prepared for the next level of education in Senior High School.
              </p>
            </div>
          </div>
