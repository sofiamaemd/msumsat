...
<title>Industrial Technology | Faculty & Staff | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
              ...
              <a href="dit.php"><ul id="active-sbar">Industrial Technology</ul></a>
      ...
      <div class="col-2-con">
        <img id="prospectus-img-size" src="department-img/bit-img.JPG" alt="">
            ...
            <div class="slider">
                ...
                <!------------------------------->  
                    <?php
                        ...
                        $result = $mysqli->query("SELECT id, fullname, position, title, comment, image FROM it_directory");
