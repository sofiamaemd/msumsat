...
<title>Departments | Faculty & Staff | MSU Maigo</title><meta charset="utf-8">
        ...
        <input type="checkbox" id="drop" />
            <ul class="menu">
                ...
                <li>
                  ...
                  <a href="../faculty-staff.php" class="active">Faculty<span id="remove-1"> & Staff</span></a>
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Departments</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="departments.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="departments/dcs.php"><li class="option"><span class="option-text">Computer Science</span></li></a>
              <a href="departments/det.php"><li class="option"><span class="option-text">Engineering Technology</span></li></a>
              <a href="departments/dhrmt.php"><li class="option"><span class="option-text">Hotel and Restaurant Management</span></li></a>
              <a href="departments/dhess.php"><li class="option"><span class="option-text">Humanities, Education, & Social Sciences</span></li></a>
              <a href="departments/dit.php"><li class="option"><span class="option-text">Industrial Technology</span></li></a>
              <a href="departments/dnsm.php"><li class="option"><span class="option-text">Natural Science and Mathematics</span></li></a>
              <a href="departments/secondary-education/"><li class="option"><span class="option-text">Secondary Education</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="departments.php"><ul id="active-sbar">Overview</ul></a>   
              <a href="departments/dcs.php"><ul>Computer Science</ul></a>
              <a href="departments/det.php"><ul>Engineering Technology</ul></a>
              <a href="departments/dhrmt.php"><ul>Hotel and Restaurant Management</ul></a>
              <a href="departments/dhess.php"><ul>Humanities, Education, & Social Sciences</ul></a>
              <a href="departments/dit.php"><ul>Industrial Technology</ul></a>
              <a href="departments/dnsm.php"><ul>Natural Science and Mathematics</ul></a>
              <a href="departments/dse.php"><ul>Secondary Education</ul></a>
              <a href="../academics.php"><ul id="sbar-back">« Back to Academics</ul></a>
            </div>
      </div>
      <div class="col-2-con">
          <!-- Slideshow -->
          <div class="slideshow-con-subp">
            <div class="slides-subp fade">
               <img id="slide-img-size" src="departments/secondary-education/schools-img/slide-sample-1.jpg.png" alt="Image 1">
            </div>
            <div class="slides-subp fade">
               <img id="slide-img-size" src="departments/secondary-education/schools-img/slide-sample-2.jpg" alt="Image 2">
            </div>
            <div class="slides-subp fade">
               <img id="slide-img-size" src="departments/secondary-education/schools-img/slide-sample-3.jpg.png.jpg" alt="Image 3">
            </div>
        ...
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>Overview</h1>
            <p>
              Mindanao State University - Maigo School of Arts and Trades (MSU-MSAT) is a public educational
               institution in the Philippines that offers technical and vocational courses. The school has 
               several departments that are responsible for delivering quality education to the students. 
               Here is a brief overview of the departments in MSU-MSAT:
            </p>
            <div class="dept">
                <ul>
                    <li><a>Department of Computer Science</a></li>
                    <li><a>Department of Engineering Technology</a></li>
                    <li><a>Department of Hotel and Restaurant Management Technology</a></li>
                    <li><a>Department of Humanities, Education, & Social Sciences</a></li>
                    <li><a>Department of Industrial Technology</a></li>
                    <li><a>Department of Natural Science & Mathematics</a></li>
                    <li><a>Department of Secondary Education</a></li>
                </ul>
            </div>
          </div>
        </div>
...
function showSlides(n) {
 var i;
 var slides = document.getElementsByClassName("slides-subp");
