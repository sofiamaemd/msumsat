...
<title>Faculty & Staff | MSU-Maigo</title>
<meta charset="utf-8">
  ...
  <div class="body-inner-wrapper">
    <main>
      ...
      <div class="two_third first">
        <p class="textDesign">
          The MSU-MSAT faculty and staff are accomplished experts and leaders in their fields and professions. 
          With our goal for being a world-class institution, our best and brightest collaborate and work together 
          across disciplines to meet the challenges and needs of our ever evolving society.
        </p> 
        <div class="section-col-1">
          <div class="section-card-1 con-fix">
            <div class="one_half-1 first">
              <img id="img-size" src="images/body-img/Faculty-Resources-img.jpg" alt="">
            </div>
            
            <div class="one_half">
              <a id="hover-a" href="faculty-staff/faculty.php">Faculty</a>
              <p>
                Offices and resources provide supports to MSU-MSAT faculty 
              </p>
              <ul>
                <ul>
                  <li><a href="faculty-staff/faculty-resources/development-programs.php">Development Programs</a></li>
                  <li><a href="faculty-staff/faculty-resources/faculty-directory.php">Faculty Directory</a></li>
                  <li><a href="faculty-staff/faculty-resources/downloads.php">Downloads</a></li>
          ...
          <div class="section-card-2 con-fix">
            <div class="one_half-1 first">
            <img id="img-size" src="faculty-staff/f-s-img/staff-img.jpg" alt="">
            </div>
            <div class="one_half">
              <a id="hover-a" href="faculty-staff/staff-resources.php">Staff</a>
              <p>
                Administrative offices and resources MSU-MSAT staff in their work
              </p>
              <ul>
                <ul>
                  <li><a href="faculty-staff/staff-resources/administrative-policies.php">Administrative Policies</a></li>
                  <li><a href="faculty-staff/staff-resources/staff-directory.php">Staff Directory</a></li>
                  <li><a href="faculty-staff/staff-resources/downloads.php">Downloads</a></li>
                </ul>
              </ul>
            </div>
          </div> 
          <div class="section-card-3 con-fix">
            <div class="one_half-1 first">
            <img id="img-size" src="faculty-staff/f-s-img/dept-img.jpg" alt="">       
            </div>
            <div class="one_half">
              <a id="hover-a" href="faculty-staff/departments.php">Departments</a>
              <p>
                University offices and resources supports teaching personnel in their field
              </p>
              <ul class="col-card first">
                <ul>
                  <li><a href="faculty-staff/departments/dcs.php">DCS</a></li>
                  <li><a href="faculty-staff/departments/det.php">DET</a></li>
                  <li><a href="faculty-staff/departments/dhrmt.php">DHRMT</a></li>
                  <li><a href="faculty-staff/departments/dhess.php">DHESS</a></li>
                </ul>
              </ul>
              <ul  class="col-card">
                <ul>
                  <li><a href="faculty-staff/departments/dit.php">DIT</a></li>
                  <li><a href="faculty-staff/departments/dnsm.php">DNSM</a></li>
                  <li><a href="faculty-staff/departments/dse.php">DSE</a></li>
                </ul>
              </ul>
            </div>
          </div>
  ...
  <!-- create a page of this in Office n Resources -->
      ...
      <div class="one_third">
        <div class="section-col-2 rounded ">
          <img id="campus-life" src="images/semi-header-img/faculty-staff.png"> 
          <div class="board-1">
            <h1>FACULTY & STAFF: BRIEF INFO</h1>
            <h3>CONTACT</h3>
              <ul>
                <li>                
                  <i class='bi bi-envelope-fill'></i>
                  <a id="link-hover" href="#">hrmd@g.msumsat.edu.ph</a></li>
                <li>
                  ☎<a>+63 (063) 223 8641</a></li>
              </ul>
            <h3>POPULATION</h3>
              <ul>
                <li><a>Faculty Members : 70</a></li>
                <li><a>Lecturers : 12</a></li>
                <li><a>Staffs : 61</a></li>
              </ul>
            <h3>FACULTY</h3>
              <ul>
                 <li>Associate Professors : 3</li>                 
                 <li>Assistant Professors : 6</li>
                 <li>Instructors : 33</li>
                 <li>Teachers : 10</li>
              </ul>  
          </div>
        </div> 
