...
<title>Events | Home | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
                <a href="events.php"><ul id="active-sbar">Overview</ul></a>
                <a href="events/all-events.php"><ul>All Events</ul></a>
...
if ($result) {
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // Hide events after the fourth upload
            if ($counter > 4) {
            ...
            echo '<a href="../events/all-events/' . $row['pdf_path'] . '" target="_blank">';
        ...
        // Check if there are more than four events
        if ($result->num_rows > 4) {
            echo '<p>Additional events are hidden after the fourth upload.</p>';
        }
    } else {
...
?>
          ...
          <!-- Incase a Container for Events is added -->
