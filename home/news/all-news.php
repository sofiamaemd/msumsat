...
<title>All News | Home | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">All News</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
                ...
                <a href="../news.php"><li class="option"><span class="option-text">Overview</span></li></a>
                <a href="all-news.php"><li class="option"><span class="option-text">All News</span></li></a>
              </ul>
          </div>
          <div class="col-1-con first">
                <div class="sidebar-col">
                    <a href="../news.php"><ul>Overview</ul></a>
                    <a href="all-news.php"><ul id="active-sbar">All News</ul></a>
                      ...
                      <?php
                            ...
                            if ($result && $result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<a href="../all-news/' . (isset($row['pdf_path']) ? $row['pdf_path'] : '#') . '" target="_blank">'; // Added anchor tag around the button
