...
<title>Campus Overall Directory | Home | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
            <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
              ...
              <ul class="options">
                ...
                <a href="../campus-officials.php"><li class="option"><span class="option-text">Overview</span></li></a>
                <a href="../campus-officials/campus-officials-directory.php"><li class="option"><span class="option-text">Campus Official Directory</span></li></a>
                <a href="campus-overall-directory/overall-directory.php"><li class="option"><span class="option-text">Overall Directory</span></li></a>
              </ul>
          </div>
          <div class="col-1-con first">
                <div class="sidebar-col">
                  <a href="../campus-officials.php"><ul>Overview</ul></a>
                  <a href="../campus-officials/campus-officials-directory.php"><ul id="active-sbar">Campus Official Directory</ul></a>
                  <a href="campus-overall-directory/overall-directory.php"><ul>Overall Directory</ul></a>
              ...
              <div class="slider-wrapper">
                <!------------------------------->  
                    <?php
                        ...
                        $result = $mysqli->query("SELECT id, fullname, position, title, comment, image FROM employees");
