...
<title>Department Heads | Home | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          ...
          <div class="col-1-con first">
                <div class="sidebar-col">
                  ...
                  <a href="department-heads.php"><ul id="active-sbar">Department Heads</ul></a>
              ...
              <div class="col-1-subp">
                <div class="slider">
                    ...
                    <?php
                        ...
                        $result = $mysqli->query("SELECT id, fullname, position, title, comment, image FROM department_heads");
