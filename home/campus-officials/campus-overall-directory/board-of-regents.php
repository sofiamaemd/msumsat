...
<title>Board of Regents | Home | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          ...
          <div class="col-1-con first">
                <div class="sidebar-col">
                  ...
                  <a href="board-of-regents.php"><ul id="active-sbar">Board of Regents</ul></a>
                ...
                <div class="slider">
                  <div class="slider-wrapper">
                    <?php
                      ...
                      $result = $mysqli->query("SELECT id, fullname, position, title, comment, image FROM board_regents ORDER BY id ASC");
                      if ($result && $result->num_rows > 0) {
                          ...
                          while ($row = $result->fetch_assoc()) {
                              ...
                              echo '<button class="collapse-btn' . (isset($_POST['search_name']) && $_POST['search_name'] === $row['fullname'] ? ' active' : '') . '" onclick="toggleCollapse(this)">' . $row['fullname'] . '</button>';
