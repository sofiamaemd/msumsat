...
<title>MSU System Officials | Home | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          ...
          <div class="col-1-con first">
                <div class="sidebar-col">
                  ...
                  <a href="msu-system-officials.php"><ul id="active-sbar">MSU System Officials</ul></a>
                ...
                <div class="slider">
                    <div class="slider-wrapper">
                      <?php
                        ...
                        $result = $mysqli->query("SELECT id, fullname, position, title, comment, image FROM msu_system_officials");
