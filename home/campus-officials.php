...
<title>Campus Officials | Home | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      <div id="submenu" class="select-menu">
        <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
          ...
          <ul class="options">
            <a href="../home.php"><li class="option"><span>Home</span></li></a>
            <a href="campus-officials.php"><li class="option"><span>Overview</span></li></a>
            <a href="campus-officials/campus-officials-directory.php"><li class="option"><span>Campus Official Directory</span></li></a>
            <a href="campus-officials/campus-overall-directory/overall-directory.php"><li class="option"><span>Overall Directory</span></li></a>
          </ul>
      </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="campus-officials.php"><ul id="active-sbar">Overview</ul></a>
              <a href="campus-officials/campus-officials-directory.php"><ul>Campus Official Directory</ul></a>
              <a href="campus-officials/campus-overall-directory/overall-directory.php"><ul>Overall Directory</ul></a>
              <a href="../home.php"><ul id="sbar-back">« Back to Home</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="cmp-of-img-size" src="../home/campus-officials/campus-officials-img/oneMSU.png" alt="">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>Overview</h1>
            <p>
              The <span>Mindanao State University - Maigo School of Arts and Trades</span> (MSU - MSAT) is a public educational 
              institution in the Philippines that offers technical and vocational courses in various fields such 
              as automotive technology, culinary arts, welding technology, and electronics technology, among others. The <span>officials</span>
               of MSU-MSAT are responsible for ensuring the smooth operation of the institution and the quality of education that it provides.
            </p>
            <p>
              The <span>MSU-MSAT officials</span> are composed of the school director, academic dean, program coordinators, 
              faculty members, and administrative staff. They work together to develop and implement policies 
              and programs that promote the academic and personal growth of the students. The school director 
              oversees the overall administration of the school, while the academic dean supervises the academic 
              programs and faculty.
            </p>
            <p>
              The program coordinators are responsible for managing the technical and vocational courses and 
              ensuring that they are aligned with industry standards. The faculty members are experts in their 
              respective fields and are responsible for delivering quality instruction to the students. The 
              administrative staff provides support services such as student services, financial management, 
              and human resources management.
            </p>
            <p>
              <span>MSU-MSAT officials</span> play a critical role in ensuring that the institution provides high-quality 
              technical and vocational education to its students. They work together to create a learning 
              environment that fosters academic excellence, personal growth, and career development.
            </p>
          </div>
        </div>
        <div class="col-2-3" id="responsive">
          <div class="col-2-subp">
            ...
            <div class="col-3-links">
              ...
              <p><a href="../faculty-staff/faculty.php">Faculty</a></p>
              <p><a href="../faculty-staff/staff-resources.php">Staff</a></p>
