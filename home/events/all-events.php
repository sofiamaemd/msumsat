...
<title>All Events | Home | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">All Events</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
                ...
                <a href="../events.php"><li class="option"><span class="option-text">Overview</span></li></a>
                <a href="all-events.php"><li class="option"><span class="option-text">All Events</span></li></a>
              </ul>
          </div>
          <div class="col-1-con first">
                <div class="sidebar-col">
                    <a href="../events.php"><ul>Overview</ul></a>
                    <a href="all-events.php"><ul id="active-sbar">All Events</ul></a>
                  ...
                  <div class="slider">
                    <div class="slider-wrapper">
                      <?php
                            ...
                            $result = $mysqli->query("SELECT * FROM event_schedule ORDER BY id DESC");
                            if ($result && $result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<a href="../all-events/' . (isset($row['pdf_path']) ? $row['pdf_path'] : '#') . '" target="_blank">'; // Added anchor tag around the button
                                    echo '<button class="collapse-btn" onclick="toggleCollapse(this)">' . pathinfo($row['pdf_path'], PATHINFO_FILENAME) . '</button>'; // Display only the PDF title
                                    echo '</a>';
                                    echo '</div>';
