...
<title>Newsletter | Home | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Newsletter</h2>
      <div id="submenu" class="select-menu">
        <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
          ...
          <ul class="options">
            ...
            <a href="newsletter.php"><li class="option"><span class="option-text">Overview</span></li></a>
            <a href="newsletter/all-newsletter.php"><li class="option"><span class="option-text">All Newsletter</span></li></a>
          </ul>
      </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
                <a href="newsletter.php"><ul id="active-sbar">Overview</ul></a>
                <a href="newsletter/all-newsletter.php"><ul>All Newsletter</ul></a>
...
if ($result && $result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<div class="featured_newsletter">';
        echo '<a href="?id=' . $row['id'] . '" </a>';
        echo '<div class="news-letter-col-1-3-featured">';
        echo '<a href="newsletter/all-newsletter/' . $row['newsletter_pdf'] . '" download>';
        echo '<img id="img-size-featured-newsletter" src="newsletter/all-newsletter/' . $row['newsletter_img'] . '" alt=""></a>';
        echo '<div class="download-section-featured">';
        echo '<h2 <a href="newsletter/all-newsletter/' . $row['newsletter_pdf'] . '" download>' . basename($row['newsletter_pdf'], ".pdf") . '</a></h2>';
        echo '<p>' . $row['newsletter_title'] . '</p>';
        echo '<div id="respo-d-btn" class="button-position-featured">';
        echo '<a href="newsletter/all-newsletter/' . $row['newsletter_pdf'] . '" download><button id="download-button">Download<span id="d-icon">↩</span></button></a>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
