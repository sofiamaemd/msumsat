...
<title>All Newsletter | Home | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">All Newsletter</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
                ...
                <a href="all-newsletter.php"><li class="option"><span class="option-text">All Newsletter</span></li></a>
              </ul>
          </div>
          <div class="col-1-con first">
                <div class="sidebar-col">
                    <a href="../newsletter.php"><ul>Overview</ul></a>
                    <a href="all-newsletter.php"><ul id="active-sbar">All Newsletter</ul></a>
                  ...
                  <div class="slider">
                    <div class="slider-wrapper">
                      <?php
                            ...
                            $result = $mysqli->query("SELECT * FROM newsletters ORDER BY id DESC");
                            if ($result && $result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<a href="all-newsletter/' . (isset($row['newsletter_pdf']) ? $row['newsletter_pdf'] : '#') . '" target="_blank">'; // Added anchor tag around the button
                                    echo '<button class="collapse-btn" onclick="toggleCollapse(this)">' . pathinfo($row['newsletter_pdf'], PATHINFO_FILENAME) . '</button>'; // Display only the PDF title
                                    echo '</a>';
                                    echo '</div>';
