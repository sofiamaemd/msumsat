...
<title>All Announcements | Home | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Announcements</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
                ...
                <a href="all-a.php"><li class="option"><span class="option-text">Announcements</span></li></a>
              </ul>
          </div>
          <div class="col-1-con first">
                <div class="sidebar-col">
                    <a href="../announcements.php"><ul>Overview</ul></a>
                    <a href="all-announcements.php"><ul id="active-sbar">Compiled Announcements</ul></a>
                      ...
                      <?php
                            ...
                            if ($result && $result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<a href="all-announcements/' . (isset($row['pdf']) ? $row['pdf'] : '#') . '" target="_blank">'; // Added anchor tag around the button
                                    echo '<button class="collapse-btn" onclick="toggleCollapse(this)">' . pathinfo($row['pdf'], PATHINFO_FILENAME) . '</button>'; // Display only the PDF title
                                    echo '</a>';
                                    echo '</div>';
