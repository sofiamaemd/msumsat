...
<title>News | Home | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">News</h2>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
                <a href="news.php"><ul id="active-sbar">Overview</ul></a>
                <a href="news/all-news.php"><ul>All News</ul></a>
...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    echo '<div class="retrive_news news-col-1-4">';
    echo '<a href="all-news/' . (isset($row['pdf_path']) ? $row['pdf_path'] : '#') . '">';
    echo '<img id="img-size-news" src="all-news/' . $imagePath . '" alt="">';
