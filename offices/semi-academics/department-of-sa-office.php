...
<title>Department of Student Affairs Office | Offices & Resources | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="office-of-the-administration.php"><li class="option"><span class="option-text">Office of the Administration</span></li></a>
              <a href="guidance-counseling-office.php"><li class="option"><span class="option-text">Guidance and Counseling Office</span></li></a>
              <a href="department-of-sa-office.php"><li class="option"><span class="option-text">Department of Student Affairs Office</span></li></a>
              <a href="university-library.php"><li class="option"><span class="option-text">University Library</span></li></a>
              <a href="nstp.php"><li class="option"><span class="option-text">National Service Training Program</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../semi-academics.php"><ul>Overview</ul></a>
              <a href="office-of-the-administration.php"><ul>Office of the Administration</ul></a>
              <a href="guidance-counseling-office.php"><ul>Guidance and Counseling Office</ul></a>
              <a href="department-of-sa-office.php"><ul id="active-sbar">Department of Student Affairs Office</ul></a>
              <a href="university-library.php"><ul>University Library</ul></a>
              <a href="nstp.php"><ul>National Service Training Program</ul></a>
