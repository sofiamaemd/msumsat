...
<title>Academics | Offices & Resources | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Academics</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="academics.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="academics/office-of-the-doi.php"><li class="option"><span class="option-text">Office of the Dean of Instructions</span></li></a>
              <a href="academics/secondary-office.php"><li class="option"><span class="option-text">Department of Secondary Office</span></li></a>
              <a href="academics/dhrmt-office.php"><li class="option"><span class="option-text">Department of Hotel and Restaurant Management Technology Office</span></li></a>
              <a href="academics/dhess-office.php"><li class="option"><span class="option-text">Department of Humanities, Education and Social Sciences Office</span></li></a>
              <a href="academics/dcs-office.php"><li class="option"><span class="option-text">Department of Computer Science Office</span></li></a>
              <a href="academics/dnsm-office.php"><li class="option"><span class="option-text">Department of Natural Sciences and Mathematics Office</span></li></a>
              <a href="academics/dit-office.php"><li class="option"><span class="option-text">Department of Industrial Technology Office</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="academics.php"><ul id="active-sbar">Overview</ul></a>
              <a href="academics/office-of-the-doi.php"><ul>Office of the Dean of Instructions</ul></a>
              <a href="academics/secondary-office.php"><ul>Department of Secondary Office</ul></a>
              <a href="academics/dhrmt-office.php"><ul>Department of Hotel and Restaurant Management Technology Office</ul></a>
              <a href="academics/dhess-office.php"><ul>Department of Humanities, Education and Social Sciences Office</ul></a>
              <a href="academics/dcs-office.php"><ul>Department of Computer Science Office</ul></a>
              <a href="academics/dnsm-office.php"><ul>Department of Natural Sciences and Mathematics Office</ul></a>
              <a href="academics/dit-office.php"><ul>Department of Industrial Technology Office</ul></a>
