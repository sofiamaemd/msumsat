...
<title>Research & Extension | Offices & Resources | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Research & Extension</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              <a href="../offices-resources.php"><li class="option"><span class="option-text">Offices & Resources</span></li></a>
              <a href="office-of-the-campus-head.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="research-extension/office-of-the-accountants.php"><li class="option"><span class="option-text">Office of the Accountants</span></li></a>
              <a href="research-extension/office-of-the-auditors.php"><li class="option"><span class="option-text">Office of the Auditors</span></li></a>
              <a href="research-extension/office-of-the-cashering-division.php"><li class="option"><span class="option-text">Office of the Cashering Division</span></li></a>
              <a href="research-extension/hr-office.php"><li class="option"><span class="option-text">Human Resource Management Office</span></li></a>
              <a href="research-extension/medical-dental-clinic.php"><li class="option"><span class="option-text">Medical & Dental Clinic</span></li></a>
              <a href="research-extension/budget-office.php"><li class="option"><span class="option-text">Budget Office</span></li></a>
              <a href="research-extension/supply-office.php"><li class="option"><span class="option-text">Supply Office</span></li></a>
              <a href="research-extension/security-office.php"><li class="option"><span class="option-text">Security Office</span></li></a>
              <a href="research-extension/tesda-office.php"><li class="option"><span class="option-text">TESDA Office</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="research-extension.php"><ul id="active-sbar">Overview</ul></a>
              <a href="research-extension/office-of-the-accountants.php"><ul>Office of the Accountants</ul></a>
              <a href="research-extension/office-of-the-auditors.php"><ul>Office of the Auditors</ul></a>
              <a href="research-extension/office-of-the-cashering-division.php"><ul>Office of the Cashering Division</ul></a>
              <a href="research-extension/hr-office.php"><ul>Human Resource Management Office</ul></a>
              <a href="research-extension/medical-dental-clinic.php"><ul>Medical & Dental Clinic</ul></a>
              <a href="research-extension/budget-office.php"><ul>Budget Office</ul></a>
              <a href="research-extension/supply-office.php"><ul>Supply Office</ul></a>
              <a href="research-extension/security-office.php"><ul>Security Office</ul></a>
              <a href="research-extension/tesda-office.php"><ul>TESDA Office</ul></a>
              <a href="../offices-resources.php"><ul id="sbar-back">« Back to Offices & Resources</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="prospectus-img-size" src="../campus-life/campus-life-img/sample-img.png" alt="">
