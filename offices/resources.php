...
<title>Overview | Offices & Resources | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Resources</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="resources.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="resources/e-library.php"><li class="option"><span class="option-text">e-Library</span></li></a>
              <a href="resources/faculty-resources.php"><li class="option"><span class="option-text">Faculty Resources</span></li></a>
              <a href="resources/staff-resources.php"><li class="option"><span class="option-text">Staff Resources</span></li></a>
              <a href="resources/teaching-resources.php"><li class="option"><span class="option-text">Teaching Resources</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="resources.php"><ul id="active-sbar">Overview</ul></a>
              <a href="resources/e-library.php"><ul>e-Library</ul></a>
              <a href="resources/faculty-resources.php"><ul>Faculty Resources</ul></a>
              <a href="resources/staff-resources.php"><ul>Staff Resources</ul></a>
              <a href="resources/teaching-resources.php"><ul>Teaching Resources</ul></a>
