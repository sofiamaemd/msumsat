...
<title>TESDA Office | Offices & Resources | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="../research-extension.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="office-of-the-accountants.php"><li class="option"><span class="option-text">Office of the Accountants</span></li></a>
              <a href="office-of-the-auditors.php"><li class="option"><span class="option-text">Office of the Auditors</span></li></a>
              <a href="office-of-the-cashering-division.php"><li class="option"><span class="option-text">Office of the Cashering Division</span></li></a>
              <a href="hr-office.php"><li class="option"><span class="option-text">Human Resource Management Office</span></li></a>
              <a href="medical-dental-clinic.php"><li class="option"><span class="option-text">Medical & Dental Clinic</span></li></a>
              <a href="budget-office.php"><li class="option"><span class="option-text">Budget Office</span></li></a>
              <a href="supply-office.php"><li class="option"><span class="option-text">Supply Office</span></li></a>
              <a href="security-office.php"><li class="option"><span class="option-text">Security Office</span></li></a>
              <a href="tesda-office.php"><li class="option"><span class="option-text">TESDA Office</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../research-extension.php"><ul>Overview</ul></a>
              <a href="office-of-the-accountants.php"><ul>Office of the Accountants</ul></a>
              <a href="office-of-the-auditors.php"><ul>Office of the Auditors</ul></a>
              <a href="office-of-the-cashering-division.php"><ul>Office of the Cashering Division</ul></a>
              <a href="hr-office.php"><ul>Human Resource Management Office</ul></a>
              <a href="medical-dental-clinic.php"><ul>Medical & Dental Clinic</ul></a>
              <a href="budget-office.php"><ul>Budget Office</ul></a>
              <a href="supply-office.php"><ul>Supply Office</ul></a>
              <a href="security-office.php"><ul>Security Office</ul></a>
              <a href="tesda-office.php"><ul id="active-sbar">TESDA Office</ul></a>
              <a href="../../offices-resources.php"><ul id="sbar-back">« Back to Offices & Resources</ul></a>  
            </div>
      </div>
      <div class="col-2-con">
        <div class="col-2-2-prof">
          <div class="col-1-subp">
          <img class="max-img" src="../../about/about-img/underconstruction.jpg" alt="">
          </div>
        </div>
        <div class="col-2-3-prof">
          <div class="col-2-subp">
            <div class="col-3-links">
              <div class="profile-con rounded">
                 <center><img src="../../images/sample-pic.png" alt=""> </center>
                 <div class="prof-text-content">
                   <center><P>Atty. Jamaloden A. Basar</P></center>
                   <center><p>Chancellor</p></center>
                 </div>             
              </div>
            </div>
          </div>
          <div class="col-2-subp">
            <div class="contact-cont">
              <h1>Contacts Us</h1>
              <div class="col-3-links">
                <p><span>Telephone:</span>xxx-xxxx/xxx-xxxx</p>
                 <p><span>Email:</span><a href=""> campushead@g.msat.edu.ph</a></p>
              </div>
            </div>
          </div>
        </div>
