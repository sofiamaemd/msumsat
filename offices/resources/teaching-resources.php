...
<title>Faculty Resources | Offices & Resources | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="e-library.php"><li class="option"><span class="option-text">e-Library</span></li></a>
              <a href="faculty-resources.php"><li class="option"><span class="option-text">Faculty Resources</span></li></a>
              <a href="staff-resources.php"><li class="option"><span class="option-text">Staff Resources</span></li></a>
              <a href="teaching-resources.php"><li class="option"><span class="option-text">Teaching Resources</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../resources.php"><ul>Overview</ul></a>
              <a href="e-library.php"><ul>e-Library</ul></a>
              <a href="faculty-resources.php"><ul>Faculty Resources</ul></a>
              <a href="staff-resources.php"><ul>Staff Resources</ul></a>
              <a href="teaching-resources.php"><ul id="active-sbar">Teaching Resources</ul></a>
