...
<title>Downloads | Offices & Resources | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="message.php"><li class="option"><span class="option-text">Messages</span></li></a>
              <a href="downloads.php"><li class="option"><span class="option-text">Downloads</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../office-of-the-campus-head.php"><ul>Overview</ul></a>
              <a href="message.php"><ul>Messages</ul></a>
              <a href="downloads.php"><ul id="active-sbar">Downloads</ul></a>
