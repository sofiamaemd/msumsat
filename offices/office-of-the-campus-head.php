...
<title>Office of the Campus Head | Offices & Resources | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="office-of-the-campus-head/message.php"><li class="option"><span class="option-text">Messages</span></li></a>
              <a href="office-of-the-campus-head/downloads.php"><li class="option"><span class="option-text">Downloads</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="office-of-the-campus-head.php"><ul id="active-sbar">Overview</ul></a>
              <a href="office-of-the-campus-head/message.php"><ul>Messages</ul></a>
              <a href="office-of-the-campus-head/downloads.php"><ul>Downloads</ul></a>
              <a href="../offices/administration.php"><ul id="sbar-back">«Back to Administration</ul></a>
            </div>
      </div>
      <div class="col-2-con">
