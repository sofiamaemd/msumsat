...
<title>Extension & Community Service Office | Offices & Resources | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="../office-of-the-campus-head.php"><li class="option"><span class="option-text">Office of the Campus Head</span></li></a>
              <a href="office-of-the-registrar.php"><li class="option"><span class="option-text">Office of the Registrar</span></li></a>
              <a href="office-of-the-guidance-counselor.php"><li class="option"><span class="option-text">Office of the Guidance Counselor</span></li></a>
              <a href="development-planning-office.php"><li class="option"><span class="option-text">Development & Planning Office</span></li></a>
              <a href="administration-finance-office.php"><li class="option"><span class="option-text">Administration & Finance Office</span></li></a>
              <a href="extension-community-service-office.php"><li class="option"><span class="option-text">Extension & Community Services Office</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../administration.php"><ul>Overview</ul></a>
              <a href="../office-of-the-campus-head.php"><ul>Office of the Campus Head</ul></a>
              <a href="office-of-the-registrar.php"><ul>Office of the Registrar</ul></a>
              <a href="office-of-the-guidance-counselor.php"><ul>Office of the Guidance Counselor</ul></a>
              <a href="development-planning-office.php"><ul>Development & Planning Office</ul></a>
              <a href="administration-finance-office.php"><ul>Administration & Finance Office</ul></a>
              <a href="extension-community-service-office.php"><ul id="active-sbar">Extension & Community Services Office</ul></a>
