...
<title>Academics | MSU Maigo</title>
<meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      ...
      <div class="two_third first">
        <p class="textDesign">
          MSU-MSAT offers the quality education needed by the students to meet the competitive global 
          standards with eight (8) degree-programs including secondary and graduate studies to suit 
          students' individual talents and passion
        </p> 
        <div class="section-col-1">
          <div class="board con-fix">
            <div class="half first">
              <h1><a id="hover-h-1" href="faculty-staff/departments.php">Departments</a></h1>
                <ul>
                  <li><a href="faculty-staff/departments/dcs.php">Computer Science</a></li>
                  <li><a href="faculty-staff/departments/det.php">Engineering Technology</a></li>
                  <li><a href="faculty-staff/departments/dhrmt.php">Hotel and Restaurant Management</a></li>
                  <li><a href="faculty-staff/departments/dhess.php">Humanities, Education, and Social Sciences</a></li>
                  <li><a href="faculty-staff/departments/dit.php">Industrial Technology</a></li>
                  <li><a href="faculty-staff/departments/dnsm.php">Natural Science and Mathematics Technology</a></li>
                </ul>
            </div>
            <div class="half">
              <h1><a id="hover-h-1" href="faculty-staff/departments/dse.php">Secondary Education</a></h1>
                  <ul>
                    <li><a href="faculty-staff/departments/secondary-education/jhs.php">Junior High School</a></li>
                    <li><a href="faculty-staff/departments/secondary-education/shs.php">Senior High School</a></li>
                  </ul>
              <h1><a id="hover-h-1" href="offices/research-extension/tesda-office.php">TESDA (<span class="tesda"> MSU-MSAT </span>)</a></h1>
                  <ul>
          ...
          <div class="section-card-1 con-fix">
            ...
            <img id="img-size" src="academics/acad-img/acad-img.jpg" alt="">
            </div>
            
            <div class="one_half">
              <a>Academic Programs</a>
              <p>
                We offers a diverse range of undergraduate, graduate programs and special programs in various fields, 
                providing students with hands-on experience and practical skills to succeed in their 
                chosen career paths.
              </p>
              <ul>
                <ul >
                  <li><a href="academics/programs-offered.php">Programs Offered</a></li>
                  <li><a href="admissions/requirements.php">Requirements</a></li>
                  <li><a href="admissions/requirements.php">Prospectus</a></li>
                </ul>
              </ul>
            </div>
          </div>
          <div class="section-card-2 con-fix">
            <div class="one_half-1 first">
            <img id="img-size" src="academics/acad-img/acad-cal-img.jpg" alt="">
            </div>
            <div class="one_half">
              <a>Academic Calendar</a>
              <p>
                MSU-MSAT Highlights important academic dates, such as registration 
                deadlines, holidays, and exam schedules, to ensure a smooth academic experience for students.
              </p>
              <ul>
                <ul>
                  <li><a href="offices/semi-academics/guidance-counseling-office.php">Admission Office</a></li>
                  <li><a id="link-disable">Academic Calendar</a></li>
  ...
  <!-- create a page of this in Office n Resources -->
      </div>
      <div class="one_third">
        <div class="section-col-2 rounded ">
    <img id="acad" src="images/semi-header-img/academics-img.png"> 
          <div class="board-1">
            <h1>ACADEMICS: BRIEF INFO</h1>
            <h3>CONTACT</h3>
              <ul>
                <li>                
                  <i class='bi bi-envelope-fill'></i>
                  <a id="link-hover" href="mailto:daisuke.cs19@gmail.com">academics@g.msumsat.edu.ph</a></li>
                <li>
                  ☎<a>+63 (063) 223 - 8641</a></li>
              </ul>
            <h3>POPULATION</h3>
              <ul>
                <li><a>Teaching Personnel : 70</a></li>
                <li><a>Non-Teaching Personnel : 61</a></li>
              </ul>
            <h3>COURSES</h3>
              <ul>
                 ...
                 <li>Bachelor of Technology and Livelihood Education (BTLEd)</li>
                 <li>Bachelor of Industrial Technology (BIT)</li>
                 <li>Certificate in Professional Teaching (CPrT)</li>
              </ul>  
              <p><a href="academics/programs-offered.php">
