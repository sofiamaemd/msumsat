...
<title>Supreme Student Counsel | Campus Life | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="ssc.php"><li class="option"><span class="option-text">Supreme Student Counsel</span></li></a>
              <a href="rotc.php"><li class="option"><span class="option-text">Reserve Officers' Training Corps</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../students-organization.php"><ul>Overview</ul></a>
              <a href="ssc.php"><ul id="active-sbar">Supreme Student Counsel</ul></a>
              <a href="rotc.php"><ul>Reserve Officers' Training Corps</ul></a>
              <a href="../../campus-life.php"><ul id="sbar-back">« Back to Campus Life</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="prospectus-img-size" src="../../campus-life/campus-life-img/ssc-img.jpg" alt="">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>Overview</h1>
            <p>
              The Supreme Student Council (SSC) at MSU Maigo refers to the representative body of students 
              elected to serve as the official student government in Maigo State University. The SSC plays 
              a vital role in representing the interests and concerns of the student body, promoting student
              welfare, and fostering a vibrant campus community.
            </p>
          </div>
        </div>
