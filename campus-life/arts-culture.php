...
<title>Arts & Culture | Campus Life | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Arts & Culture</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="arts-culture/indayog.php"><li class="option"><span class="option-text">INDAYOG</span></li></a>
              <a href="arts-culture/innoband.php"><li class="option"><span class="option-text">INNO BAND</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="arts-culture.php"><ul id="active-sbar">Overview</ul></a>
              <a href="arts-culture/indayog.php"><ul>INDAYOG</ul></a>
              <a href="arts-culture/innoband.php"><ul>INNO BAND</ul></a>
              <a href="../campus-life.php"><ul id="sbar-back">« Back to Campus Life</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="prospectus-img-size" src="../campus-life/campus-life-img/arts-culture-img.png" alt="">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>Overview</h1>
            <p>
              MSU-MSAT promotes arts and culture through academic and extracurricular programs, showcasing 
              various forms of art and nurturing students' cultural inclinations. The campus celebrates 
              regional cultural traditions and promotes cross-cultural understanding through festivals, 
              exhibits, concerts, and performances. Arts and culture are essential for a well-rounded 
              education and a more vibrant and inclusive society.
            </p>
            <div class="one_whole">
              <div class="col-1-subp-half">
                <h1>INDAYOG</h1>
                <p>
                  Celebrates the diverse cultural traditions of the region and promotes cross-cultural understanding and harmony. 
                  It features various cultural activities such as music, dance, theater, exhibits, and performances. Indayog 
                  aims to showcase the rich cultural heritage of the region and to instill in students a sense of 
                  appreciation and respect for their cultural roots.
                </p>
              </div>
              <div class="col-2-subp-half">
                <center><img id="indayog-img-size" src="campus-life-img/indayog-img.png" alt=""></center>
              </div>
            </div>
            <div class="one_whole">
              <div class="col-1-subp-half">
              ...
              <div class="col-2-subp-half">
                <center><img id="indayog-img-size" src="campus-life-img/innoband-img.jpg" alt=""></center>
              </div>
            </div>
