...
<title>Students Organization | Campus Life | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Students Organization</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              <a href="../admissions.php"><li class="option"><span class="option-text">Campus Life</span></li></a>
              <a href="students-organization.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="student-organization/ssc.php"><li class="option"><span class="option-text">Supreme Student Counsel</span></li></a>
              <a href="student-organization/rotc.php"><li class="option"><span class="option-text">Reserve Officers' Training Corps</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="students-organization.php"><ul id="active-sbar">Overview</ul></a>
              <a href="student-organization/ssc.php"><ul>Supreme Student Counsel</ul></a>
              <a href="student-organization/rotc.php"><ul>Reserve Officers' Training Corps</ul></a>
              <a href="../campus-life.php"><ul id="sbar-back">« Back to Campus Life</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="prospectus-img-size" src="../campus-life/campus-life-img/overview-stud-org=img.jpg" alt="">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>Overview</h1>
            <p>
            A student organization, also known as a student club or student group, is a collective of 
            students who come together based on shared interests, goals, or causes within an educational 
            institution. These organizations provide students with opportunities to engage in extracurricular 
            activities, pursue personal interests, develop leadership skills, and contribute to campus life.
            </p>
          </div>
        </div>
