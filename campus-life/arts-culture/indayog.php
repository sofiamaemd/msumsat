...
<title>INDAYOG | Campus Life | MSU Maigo</title><meta charset="utf-8">
        ...
        <input type="checkbox" id="drop" />
            <ul class="menu">
                ...
                <li>
                  ...
                  <a href="../../campus-life.php" class="active">Campus Life</a>
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">INDAYOG</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              <a href="../../campus-life.php"><li class="option"><span class="option-text">Campus Life</span></li></a>
              <a href="../arts-culture.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="indayog.php"><li class="option"><span class="option-text">INDAYOG</span></li></a>
              <a href="innoband.php"><li class="option"><span class="option-text">INNO BAND</span></li></a>
              <a href="awards.php"><li class="option"><span class="option-text">Awards</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../arts-culture.php"><ul>Overview</ul></a>
              <a href="indayog.php"><ul id="active-sbar">INDAYOG</ul></a>
              <a href="innoband.php"><ul>INNO BAND</ul></a>
              <a href="awards.php"><ul>Awards</ul></a>
              <a href="../../campus-life.php"><ul id="sbar-back">« Back to Campus Life</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp bold-span">
            <h1>INDAYOG</h1>
            <p>
              <span>Indayog</span> is an organization in MSU-MSAT that promotes traditional Filipino dance and music. 
              It aims to preserve and showcase the rich cultural heritage of the Philippines through various 
              performances and activities. <span>Indayog</span> provides opportunities for students to develop their skills 
              in traditional dance and music while also fostering a sense of pride and appreciation for their 
              cultural roots. The organization serves as a platform for cultural exchange and encourages 
              cross-cultural understanding and cooperation. <span>Indayog</span> is an essential part of MSU-MSAT's efforts 
              to promote and celebrate the diverse cultural traditions of the Philippines.<br><br>
              Why <span>INDAYOG?</span><br>
            </p>
            <p>
              The term "<span>Indayog</span>" is derived from a Visayan term that means "<span>rhythm</span>"  or "<span>beat</span>." It was chosen 
              to represent the group's commitment to promoting cultural diversity and celebrating the unique 
              cultural heritage of the Philippines.
            </p>
            <p>
              <span>Indayog</span> was established in MSU-MSAT in 1987 as a response to the need for a performing arts group 
              that would represent the university in various cultural events and competitions. It was initially 
              composed of faculty members and students who were interested in music, dance, and theater. Over the 
              years, <span>Indayog</span> has become a prominent organization in the university, promoting the <span>Arts & Culture</span> 
              of the Maranao people and showcasing the talents of its members.
            </p>
          </div>
        </div>
