...
<title>Martians | Campus Life | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Sports Club</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="../sports-club.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="martians.php"><li class="option"><span class="option-text">Martians</span></li></a>
              <a href="awards.php"><li class="option"><span class="option-text">Awards</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../sports-club.php"><ul>Overview</ul></a>
              <a href="martians.php"><ul id="active-sbar">Martians</ul></a>
      ...
      <div class="col-2-con">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp bold-span">
            <h1>MARTIANS</h1>
              <p>
                <span>Martians</span> is a community of faculty-students in MSU MSAT who are primarily athletes. 
                The group's name is inspired by the extraterrestrial planet Mars, which is often associated 
                with strength, endurance, and athleticism. The <span>Martians</span> group was formed to provide a 
                supportive and inclusive community for student-athletes, as well as to promote fitness 
                and healthy living among the student body.
              </p>
              <p>
                The <span>Martians</span> is an open to all faculty-students who are involved in sports and other 
                physical activities, regardless of skill level. The group organizes various events 
                and activities throughout the year, including sports tournaments, fitness challenges, 
                and community service projects. The <span>Martians</span> also serves as a platform for 
                student-athletes to connect and collaborate with each other, as well as with faculty 
                and staff members who are involved in sports and physical education.
              </p>
              <p>
                The <span>Martians</span> community focuses on athletics and physical fitness is in line with 
                <span>MSU-MSAT Mission's</span> to promote a holistic approach to education that emphasizes the development of 
                both the mind and the body. The group also contributes to MSU MSAT's goal of fostering a 
                sense of community and camaraderie among its students, faculty, and staff members.
              </p>            
          </div>
        </div>
        <div class="col-2-3" id="responsive">
          <div class="col-2-subp">
            ...
            <div class="col-3-links">
              ...
              <p><a href="../../home/events.php">Calendar of Events</a></p>
            </div>
          </div>
        </div>
      </div>
