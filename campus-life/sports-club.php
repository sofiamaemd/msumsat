...
<title>Sports Club | Campus Life | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="sports-club/martians.php"><li class="option"><span class="option-text">Martians</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="sports-club.php"><ul id="active-sbar">Overview</ul></a>
              <a href="sports-club/martians.php"><ul>Martians</ul></a>
              <a href="../campus-life.php"><ul id="sbar-back">« Back to Campus Life</ul></a>
            </div>
      </div>
      <div class="col-2-con">
      <img id="prospectus-img-size" src="../images/Friendship-Games-img.jpg" alt="">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>Overview</h1>
            <p>
            A sports club is a membership-based organization that promotes and facilitates 
            participation in various sports activities. These clubs are created with the 
            purpose of bringing together individuals who share a common interest in sports, 
            fostering a sense of community, and providing opportunities for physical fitness, 
            skill development, and competitive engagement.
            </p>
          </div>
        </div>
