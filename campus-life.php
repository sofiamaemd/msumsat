...
<title>Campus Life | MSU Maigo</title>
<meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header">Life at Campus</h2>
      <div class="two_third first">
        <p class="textDesign">
          MSU-MSAT offers a great experience and life inside the campus. The University has a huge variety of 
          clubs and associations for the students to discover and different events and activities to keep the 
          campus lively.
        </p> 
        <div class="section-col-1">
          <div class="section-card-1 con-fix">
            <div class="one_half-1 first">
              <img id="img-size" src="images/body-img/Arts-Culture-img.png" alt="">
            </div>
            
            <div class="one_half">
              <a id="hover-a" href="campus-life/arts-culture.php">Arts & Culture</a>
              <p>
                MSU-MSAT offers a vibrant arts and culture scene, showcasing the creative talents of its 
                students and faculty through exhibitions, performances, and events. The university is 
                committed to nurturing the artistic expression and cultural appreciation of its community.
              </p>
            </div>
          </div>
          <div class="section-card-2 con-fix">
            <div class="one_half-1 first">
              <img id="img-size" src="images/body-img/Athletics-img.jpg" alt="">
            </div>
            <div class="one_half">
              <a id="hover-a" href="campus-life/sports-club.php">Sports Club</a>
              <p>
                Be part of the fun experiences in the university, participate in activities empowering your physical fitness and overall wellbeing.
                We offers a variety of sports activities, come join us.
              </p>
              <ul>
              </ul>
            </div>
          ...
          <div class="section-card-3 con-fix">
            <div class="one_half-1 first">
              <img id="img-size" src="images/body-img/Student-Org-img.jpg" alt="">       
            </div>
            <div class="one_half">
              <a id="hover-a" href="campus-life/students-organization.php">Student Organizations</a>
              <p>
                The student organizations here at MSU-MSAT provides educational and fun social events which 
                enable students to develop their management, leadership, communication and social skills.              
              </p>
            </div>
          </div>
          <div class="section-card-4 con-fix">
            <div class="one_half-1 first">
              <img id="img-size" src="images/body-img/Campus-Event-img.jpg" alt="">
            </div>
            <div class="one_half">
              <a>Campus Events</a>
              <p>
                The university hosts various campus events throughout the year, providing opportunities for students 
                to engage in a range of activities and initiatives.
                Take a look at our '<a id="hover-a" href="home.php">calendar of events</a>' page to keep track of the action.           
              </p>
            </div>
          </div> 
        </div>
  <!-- create a page of this in Office n Resources -->
      ...
      <div class="one_third">
        <div class="section-col-2 rounded ">
          <img id="campus-life" src="images/semi-header-img/Campus-Life-img.jpg"> 
          <div class="board-1">
            <h1>CAMPUS LIFE: BRIEF INFO</h1>
            <h3>CONTACT</h3>
              <ul>
                <li>                
                  <i class='bi bi-envelope-fill'></i>
                  <a id="link-hover" href="#">dsa@g.msumsat.edu.ph</a></li>
                <li>
                  ☎<a>+63 (063) 223 8641</a></li>
              </ul>
            <h3>STUDENTS ORGANIZATIONS</h3>
              <ul>
                <li><a id="link-hover" href="campus-life/student-organization/ssc.php">Supreme Student Councel (SSC)</a></li>
                <li><a id="link-hover" href="campus-life/student-organization/rotc.php">The Reserve Officers' Training Corps (ROTC)</a></li>
              </ul>
            ...
            <h3>ATHLETICS & FITNESS</h3>
              <ul>
                 <li>Sport Center</li>
                 <li>Varsity Sports and Club Sports</li>
              </ul>  
          </div>
        </div> 
      </div>
