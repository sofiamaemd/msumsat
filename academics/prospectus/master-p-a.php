...
<title>Master of Public Administration | Academics | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
              ...
              <a href="master-p-a.php"><ul id="active-sbar">Master of Public Administration</ul></a>
              <a href="tle.php"><ul>Technology and Livelihood Education</ul></a>
              <a href="../../academics.php"><ul id="sbar-back">« Back to Academics</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img src="prospectus-img/mpa.png" alt="">
        <center><a class="pros-download" href="download/mpa.pdf" download>Download</a></center>
      </div>
    </main>
    <div class="con-fix"></div>
  </div>
