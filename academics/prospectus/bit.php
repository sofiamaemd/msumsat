...
<title>Industrial Technology | Academics | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="cs.php"><li class="option"><span class="option-text">Computer Science</span></li></a>
              <a href="CPrT.php"><li class="option"><span class="option-text">Certificate in Professional Teaching</span></li></a>
              <a href="ee.php"><li class="option"><span class="option-text">Elementary Education</span></li></a>
              <a href="hm.php"><li class="option"><span class="option-text">Hospitality Management</span></li></a>
              <a href="bit.php"><li class="option"><span class="option-text">Industrial Technology</span></li></a>
              <a href="master-p-a.php"><li class="option"><span class="option-text">Master of Arts in Education</span></li></a>
              <a href="master-a-e.php"><li class="option"><span class="option-text">Master of Public Administration</span></li></a>
              <a href="tle.php"><li class="option"><span class="option-text">Technology and Livelihood Education</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../prospectus.php"><ul>Overview</ul></a>   
              <a href="cs.php"><ul>Computer Science</ul></a>   
              <a href="CPrT.php"><ul>Certificate in Professional Teaching</ul></a>
              <a href="ee.php"><ul>Elementary Education</ul></a>
              <a href="hm.php"><ul>Hospitality Management</ul></a>
              <a href="bit.php"><ul id="active-sbar">Industrial Technology</ul></a>
              <a href="master-a-e.php"><ul>Master of Arts in Education</ul></a>
              <a href="master-p-a.php"><ul>Master of Public Administration</ul></a>
              <a href="tle.php"><ul>Technology and Livelihood Education</ul></a>
              <a href="../../academics.php"><ul id="sbar-back">« Back to Academics</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img src="prospectus-img/bit_automotive-1.png" alt="">
        <img src="prospectus-img/bit_automotive-2.png" alt="">
        <img src="prospectus-img/bit_automotive-3.png" alt="">
        <center><a class="pros-download" href="download/bit_automotive.pdf" download>Download</a></center>
        <img src="prospectus-img/bit_beautycare-1.png" alt="">
        <img src="prospectus-img/bit_beautycare-2.png" alt="">
        <center><a class="pros-download" href="download/bit_beautycare.pdf" download>Download</a></center>
        <img src="prospectus-img/bit_drafting-1.png" alt="">
        <img src="prospectus-img/bit_drafting-2.png" alt="">
        <img src="prospectus-img/bit_drafting-3.png" alt="">
        <center><a class="pros-download" href="download/bit_drafting.pdf" download>Download</a></center>
        <img src="prospectus-img/bit_fsm-1.png" alt="">
        <img src="prospectus-img/bit_fsm-2.png" alt="">
        <center><a class="pros-download" href="download/bit_fsm.pdf" download>Download</a></center>
        <img src="prospectus-img/bit_garments-1.png" alt="">
        <img src="prospectus-img/bit_garments-2.png" alt="">
        <center><a class="pros-download" href="download/bit_garments.pdf" download>Download</a></center>
        <img src="prospectus-img/bit_mechanical-1.png" alt="">
        <img src="prospectus-img/bit_mechanical-2.png" alt="">
        <center><a class="pros-download" href="download/bit_mechanical.pdf" download>Download</a></center>
      </div>
    </main>
    <div class="con-fix"></div>
  </div>
