...
<title>Programs Offered | Academics | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Programs Offered</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              <a href="../academics.php"><li class="option"><span class="option-text">Academics</span></li></a>
              <a href="programs-offered.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="programs-offered/graduate-programs.php"><li class="option"><span class="option-text">Graduate Programs</span></li></a>
              <a href="programs-offered/undergraduate-programs.php"><li class="option"><span class="option-text">Undergraduate Programs</span></li></a>
              <a href="programs-offered/secondary-education.php"><li class="option"><span class="option-text">Secondary Education</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="programs-offered.php"><ul id="active-sbar">All</ul></a>
              <a href="programs-offered/graduate-programs.php"><ul>Graduate Programs</ul></a>
              <a href="programs-offered/undergraduate-programs.php"><ul>Undergraduate Programs</ul></a>
              <a href="programs-offered/secondary-education.php"><ul>Secondary Education</ul></a>
              <a href="../academics.php"><ul id="sbar-back">« Back to Academics</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="prospectus-img-size" src="programs-offered/programs-offered-img/programs-offered-img.png" alt="">
        <div class="pg-col-2">
          <div class="pg-txt-dsgn">
            <h1>Graduate Programs</h1>
            <ul>
              <li><p>Master of Arts in Education major in School Administration</p></li>
              <li><p>Master of Public Administration</p></li>
              <li><p>Certificate in Professional Teaching (CPrT)</p></li>
            </ul>
          </div>
          <div class="pg-txt-dsgn">
            <h1>Undergraduate Programs</h1>
            <ul>
              <li><p>Bachelor of Elementary Education (BEEd)</p></li>
              <li><p>Bachelor of Science in Computer Science (BSCS)</p></li>
              <li><p>Bachelor of Science in Hospitality Management (BSHM)</p></li>
              <li><p>Bachelor of Industrial Technology (BIT) major in Automotive Technology</p></li>
              <li><p>Bachelor of Industrial Technology (BIT) major in Beauty Care and Wellness</p></li>
              <li><p>Bachelor of Industrial Technology (BIT) major in Drafting Technology </p></li>
              <li><p>Bachelor of Industrial Technology (BIT) major in Electrical Technology</p></li>
              <li><p>Bachelor of Industrial Technology (BIT) major in Food Service Management</p></li>
              <li><p>Bachelor of Industrial Technology (BIT) major in Garments, Fashion and Design</p></li>
              <li><p>Bachelor of Industrial Technology (BIT) major in Mechanical Technology</p></li>
            </ul>
          </div>
          <div class="pg-txt-dsgn">
            <h1>Secondary Programs</h1>
            <ul>
              <li><p>Senior High School (Grade 11-12)</p></li>
                <ul>
                  <span><li>a. Academic Track</li></span>
                  <ul>
                    <span><li>a.1.  Science, Technology, Engineering and Mathematics (STEM)</li></span>
                    <span><li>a.2.  Humanities and Social Science (HUMSS)</li></span>
                    <span><li>a.3.  Accounting, Business and Management (ABM)</li></span>
                  </ul>
                </ul>
                <ul>
                  <span><li>b. Technical-Vocational-Livelihood Track</li></span>
                  <ul>
                    <span><li>b.1.  Home Economics (HE)</li></span>
                    <ul>
                      <span><li>b.1.1.  Cookery/Bread and Pastry Production/Food and Beverage Service</li></span>
                      <span><li>b.1.2.  Tailoring or Dressmaking</li></span>
                    </ul>
                    <span><li>b.2.  Industrial Arts (IA)</li></span>
                    <ul>
                      <span><li>b.2.1.  Automotive Servicing</li></span>
                      <span><li>b.2.2.  Electrical Installation and Maintenance</li></span>
                      <span><li>b.2.3.  Shielded Metal Arc Welding</li></span>
                    </ul>
                    <span><li>b.3.  Information and Communication Technology (ICT)</li></span>
                    <ul>
                      <span><li>b.3.1.  Computer Systems Servicing</li></span>
                      <span><li>b.3.2.  Computer Programming </li></span>
                    </ul>
                  </ul>
                </ul>
              <li><p>Junior High School (Grade 7-10)</p></li>
            </ul>
          </div>
        </div>
        <div class="pg-col-3">
