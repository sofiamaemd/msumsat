...
<title>Academic Calendar | Academics | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Academic Calendar</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="academic-calendar.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="academic-calendar/s.y-2018-2019.php"><li class="option"><span class="option-text">S.Y 2018 - 2019</span></li></a>
              <a href="academic-calendar/s.y-2019-2020.php"><li class="option"><span class="option-text">S.Y 2019 - 2020</span></li></a>
              <a href="academic-calendar/s.y-2020-2021.php"><li class="option"><span class="option-text">S.Y 2020 - 2021</span></li></a>
              <a href="academic-calendar/s.y-2021-2022.php"><li class="option"><span class="option-text">S.Y 2021 - 2022</span></li></a>
              <a href="academic-calendar/s.y-2022-2023.php"><li class="option"><span class="option-text">S.Y 2022 - 2023</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="academic-calendar.php"><ul id="active-sbar">Overview</ul></a>
              <a href="academic-calendar/s.y-2018-2019.php"><ul>S.Y 2018 - 2019</ul></a>
              <a href="academic-calendar/s.y-2019-2020.php"><ul>S.Y 2019 - 2020</ul></a>
              <a href="academic-calendar/s.y-2020-2021.php"><ul>S.Y 2020 - 2021</ul></a>
              <a href="academic-calendar/s.y-2021-2022.php"><ul>S.Y 2021 - 2022</ul></a>
              <a href="academic-calendar/s.y-2022-2023.php"><ul>S.Y 2022 - 2023</ul></a>
              <a href="../academics.php"><ul id="sbar-back">« Back to Academics</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <p class="textDesign">
          Mindanao State University - Maigo School of Arts and Trades is dedicated to academic excellence 
          with a commitment for the holistic development of the individual and the society. Founded in 1968 
          under the provision of Republic Act (RA) 5363, MSU-IIT is known for its excellence in science and 
          technology and its passion for extensive research and community involvement.
        </p> 
      </div>
    </main>
    <div class="con-fix"></div>
