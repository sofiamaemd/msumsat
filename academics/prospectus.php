...
<title>Prospectus | Academics | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Prospectus</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              <a href="prospectus.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="../academics.php"><li class="option"><span class="option-text">Academics</span></li></a>
              <a href="prospectus/cs.php"><li class="option"><span class="option-text">Computer Science</span></li></a>
              <a href="prospectus/CPrT.php"><li class="option"><span class="option-text">Certificate in Professional Teaching</span></li></a>
              <a href="prospectus/ee.php"><li class="option"><span class="option-text">Elementary Education</span></li></a>
              <a href="prospectus/hm.php"><li class="option"><span class="option-text">Hospitality Management</span></li></a>
              <a href="prospectus/bit.php"><li class="option"><span class="option-text">Industrial Technology</span></li></a>
              <a href="prospectus/master-p-a.php"><li class="option"><span class="option-text">Master of Arts in Education</span></li></a>
              <a href="prospectus/master-a-e.php"><li class="option"><span class="option-text">Master of Public Administration</span></li></a>
              <a href="prospectus/tle.php"><li class="option"><span class="option-text">Technology and Livelihood Education</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="prospectus.php"><ul id="active-sbar">Overview</ul></a>   
              <a href="prospectus/cs.php"><ul>Computer Science</ul></a>   
              <a href="prospectus/CPrT.php"><ul>Certificate in Professional Teaching</ul></a>
              <a href="prospectus/ee.php"><ul>Elementary Education</ul></a>
              <a href="prospectus/hm.php"><ul>Hospitality Management</ul></a>
              <a href="prospectus/bit.php"><ul>Industrial Technology</ul></a>
              <a href="prospectus/master-p-a.php"><ul>Master of Arts in Education</ul></a>
              <a href="prospectus/master-a-e.php"><ul>Master of Public Administration</ul></a>
              <a href="prospectus/tle.php"><ul>Technology and Livelihood Education</ul></a>
      ...
      <div class="col-2-con">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>Overview</h1>
            <p>
              A prospectus is a document that provides information about a college or university, including 
              its programs, courses, policies, procedures, and resources. It typically serves as a guidebook 
              for prospective students, providing them with a comprehensive overview of the institution and 
              what it has to offer.
            </p>
            <p>
              Includes information about the history and mission of the institution, its academic programs, 
              admission requirements, financial aid opportunities, campus facilities, student life, and other 
              important details. It may also include testimonials from current students, faculty, and alumni, 
              as well as information about the surrounding community and local attractions.
            </p>
            <p>
              Prospective students can use the prospectus to learn more about the college or university and 
              determine whether it is a good fit for their academic and personal goals. It can also help them 
              prepare for the application process and make informed decisions about their education.
            </p>
          </div>
        </div>
