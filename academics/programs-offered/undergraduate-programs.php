...
<title>Undergraduate Programs | Academics | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
              ...
              <a href="undergraduate-programs.php"><ul id="active-sbar">Undergraduate Programs</ul></a>
              <a href="secondary-education.php"><ul>Secondary Education</ul></a>
              <a href="../../academics.php"><ul id="sbar-back">« Back to Academics</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="prospectus-img-size" src="programs-offered-img/undergrad-img.png" alt="">
        <div class="pg-col-2">
