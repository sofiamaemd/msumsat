...
<title>Secondary Education | Academics | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="graduate-programs.php"><li class="option"><span class="option-text" >Graduate Programs</span></li></a>
              <a href="undergraduate-programs.php"><li class="option"><span class="option-text" >Undergraduate Programs</span></li></a>
              <a href="secondary-education.php"><li class="option"><span class="option-text" >Secondary Education</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../programs-offered.php"><ul>All</ul></a>
              <a href="graduate-programs.php"><ul >Graduate Programs</ul></a>
              <a href="undergraduate-programs.php"><ul>Undergraduate Programs</ul></a>
              <a href="secondary-education.php"><ul id="active-sbar">Secondary Education</ul></a>
              <a href="../../academics.php"><ul id="sbar-back">« Back to Academics</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="prospectus-img-size" src="programs-offered-img/secondary-img.png" alt="">
        <div class="pg-col-2">
