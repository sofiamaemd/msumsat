...
<title>Graduate Programs | Academics | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
              ...
              <a href="graduate-programs.php"><ul id="active-sbar">Graduate Programs</ul></a>
      ...
      <div class="col-2-con">
        <img id="prospectus-img-size" src="programs-offered-img/graduate-img.png" alt="">
        <div class="pg-col-2">
