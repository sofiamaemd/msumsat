...
<title>Completed Researches | Research | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="on-going-researches.php"><li class="option"><span class="option-text">On-Going Researches</span></li></a>
              <a href="completed-researches.php"><li class="option"><span class="option-text">Completed Researches</span></li></a>
              <a href="publication.php"><li class="option"><span class="option-text">Publication</span></li></a>
              <a href="downloads.php"><li class="option"><span class="option-text">Downloads</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../student-research.php"><ul>Overview</ul></a>
              <a href="on-going-researches.php"><ul>On-Going Researches</ul></a>
              <a href="completed-researches.php"><ul id="active-sbar">Completed Researches</ul></a>
              <a href="publication.php"><ul>Publication</ul></a>
              <a href="downloads.php"><ul>Downloads</ul></a>
