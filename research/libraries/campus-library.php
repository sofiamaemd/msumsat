...
<title>Campus Library | Research | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="campus-library.php"><li class="option"><span class="option-text">Campus Library</span></li></a>
              <a href="elibrary.php"><li class="option"><span class="option-text">eLibrary</span></li></a>
              <a href="downloads.php"><li class="option"><span class="option-text">Downloads</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../libraries.php"><ul>Overview</ul></a>
              <a href="campus-library.php"><ul id="active-sbar">Campus Library</ul></a>
              <a href="elibrary.php"><ul>eLibrary</ul></a>
