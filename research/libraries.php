...
<title>Libraries | Research | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Libraries</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="libraries.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="libraries/campus-library.php"><li class="option"><span class="option-text">Campus Library</span></li></a>
              <a href="libraries/elibrary.php"><li class="option"><span class="option-text">eLibrary</span></li></a>
              <a href="libraries/downloads.php"><li class="option"><span class="option-text">Downloads</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="libraries.php"><ul id="active-sbar">Overview</ul></a>
              <a href="libraries/campus-library.php"><ul>Campus Library</ul></a>
              <a href="libraries/elibrary.php"><ul>eLibrary</ul></a>
              <a href="libraries/downloads.php"><ul>Downloads</ul></a>
