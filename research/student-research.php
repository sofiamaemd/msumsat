...
<title>Student Research | Research | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Student Research</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="student-research.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="student-research/on-going-researches.php"><li class="option"><span class="option-text">On-Going Researches</span></li></a>
              <a href="student-research/completed-researches.php"><li class="option"><span class="option-text">Completed Researches</span></li></a>
              <a href="student-research/publication.php"><li class="option"><span class="option-text">Publication</span></li></a>
              <a href="student-research/downloads.php"><li class="option"><span class="option-text">Downloads</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="student-research.php"><ul id="active-sbar">Overview</ul></a>
              <a href="student-research/on-going-researches.php"><ul>On-Going Researches</ul></a>
              <a href="student-research/completed-researches.php"><ul>Completed Researches</ul></a>
              <a href="student-research/publication.php"><ul>Publication</ul></a>
              <a href="student-research/downloads.php"><ul>Downloads</ul></a>
