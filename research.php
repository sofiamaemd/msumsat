...
<title>Research | MSU Maigo</title>
<meta charset="utf-8">
        ...
        <input type="checkbox" id="drop" />
            <ul class="menu">
                ...
                <li>
                  ...
                  <a href="research.php" class="active">Research</a>
  ...
  <div class="body-inner-wrapper">
    <main>
      ...
      <div class="two_third first">
        <p class="textDesign">
          The University will initiate and undertake projects and studies which will bear on the manpower needs, 
          the industrial growth of Iligan and other development projects including those needed by the specific 
          industries and environs (MSU Charter: R.A. 5385). The MSU-MSAT researchers include faculty members, 
          visiting scholars, post-doctoral fellows, and graduate and undergraduate students, and they collaborate 
          with colleagues across the University, at affiliated institutions, and at other research institutions.
        </p> 
        <div class="section-col-1">
          <div class="section-card-2 con-fix">
            <div class="one_half-1 first">
              <img id="img-size" src="images/body-img/Faculty-Research-img.jpg" alt="">
            </div>
            <div class="one_half">
              <a id="hover-a" href="research/faculty-research.php">Faculty Research</a>
              <p>
                We conduct innovative research to address real-world challenges and 
                promote global engagement and peace-building initiatives.             
              </p>
              <ul>
                <ul>
                  <li><a href="research/faculty-research/on-going-researches.php">On-Going Researches</a></li>
                  <li><a href="research/faculty-research/completed-researches.php">Completed Researches</a></li>
                  <li><a href="research/faculty-research/publication.php">Publication</a></li>
                  <li><a href="research/faculty-research/downloads.php">Downloads</a></li>
                </ul>
              </ul>
            </div>
          </div> 
          <div class="section-card-3 con-fix">
            <div class="one_half-1 first">
              <img id="img-size" src="images/body-img/Students-Research-img.png" alt="">       
            </div>
            <div class="one_half">
              <a id="hover-a" href="research/student-research.php">Student Research</a>
              <p>
                Students engage in research activities and make a positive impact in various fields,
                with opportunities to work alongside faculty members and gain valuable experience in their respective fields.            
              </p>
              <ul>
                <ul>
                  <li><a href="research/student-research/on-going-researches.php">On-Going Researches</a></li>
                  <li><a href="research/student-research/completed-researches.php">Completed Researches</a></li>
                  <li><a href="research/student-research/publication.php">Publication</a></li>
                  <li><a href="research/student-research/downloads.php">Downloads</a></li>
                </ul>
              </ul>
            </div>
          </div>
          <div class="section-card-4 con-fix">
            <div class="one_half-1 first">
              <img id="img-size" src="images/body-img/Libraries-img.jpg" alt="">
            </div>
            <div class="one_half">
              <a id="hover-a" href="research/libraries.php">Libraries</a>
              <p>
                University library provides access to a vast collection of scholarly resources, including books, 
                journals, and electronic databases, to support research and academic excellence.          
              </p>
              <ul>
                <ul>
                  <li><a href="research/libraries/campus-library.php">Campus Library</a></li>
                  <li><a href="research/libraries/elibrary.php">eLibrary</a></li>
                  <li><a href="research/libraries/downloads.php">Downloads</a></li>
                </ul>
              </ul>
            </div>
          </div> 
      ...
      <div class="one_third">
        <div class="section-col-2 rounded ">
          <img id="campus-life" src="images/semi-header-img/Research-img.jpg"> 
          <div class="board-1">
            <h1>RESEARCH: BRIEF INFO</h1>
            <h3>CONTACT</h3>
              <ul>
                <li>                
                  <i class='bi bi-envelope-fill'></i>
                  <a id="link-hover" href="#">research@g.msumsat.edu.ph</a></li>
                <li>
                  ☎<a>+63 (063) 223 8641</a></li>
              </ul>
            <h3>FACULTY & STAFF</h3>
              <ul>
                <li><a>Faculty Members : 20</a></li>
                <li><a>Staff Members : 20</a></li>
              </ul>
            <h3>RESEARCHES</h3>
              <ul>
                <li><a>Completed Researches : 58</a></li>
                <li><a>On-going Researches : 58</a></li>
              </ul>  
          </div>
        </div> 
      </div>
