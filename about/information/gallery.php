...
<title>Gallery | About | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
                ...
                <a href="gallery.php"><ul id="active-sbar">Gallery</ul></a>
      ...
      <div class="col-2-con">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
                     <style>
                        .col-2-gallery{display:inline-block;float:left;width:47%;margin: 10px 10px 0px 10px;}
        ...
        if ($result && $result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<img src="../../my.Account/admin/gallery-images/' . $row['gallery_image'] . '" alt="">';
                echo '</div>';
                echo '</div>';
                $count++;
            }
