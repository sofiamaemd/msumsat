...
<title>Accommodation | About | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="../information.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="maps-and-directions.php"><li class="option"><span class="option-text" >Maps & Directions</span></li></a>
              <a href="facilities.php"><li class="option"><span class="option-text" >Facilities</span></li></a>
              <a href="gallery.php"><li class="option"><span class="option-text" >Gallery</span></li></a>
              <a href="accommodation.php"><li class="option"><span class="option-text" >Accommodation</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
                <a href="../information.php"><ul>Overview</ul></a>
                <a href="maps-and-directions.php"><ul>Maps & Directions</ul></a>
                <a href="facilities.php"><ul>Facilities</ul></a>
                <a href="gallery.php"><ul>Gallery</ul></a>
                <a href="accommodation.php"><ul id="active-sbar">Accommodation</ul></a>
                <a href="../../about.php"><ul id="sbar-back">« Back to About</ul></a>
            </div>
      </div>
      <div class="col-2-con">
      <img id="prospectus-img-size" src="../about-img/hotel-img.png" alt="">
          ...
          <div class="col-1-subp">
            ...
            <div class="one_whole">
                <div class="col-1-subp-half">
                  ...
                  <center><img id="indayog-img-size" src="../about-img/hotel.jpg" alt=""></center>
                  </div>   
            </div>
            <div class="one_whole">
                <div class="col-1-subp-half">
                  ...
                  <div class="col-2-subp-half">
                  <center><img id="indayog-img-size" src="../about-img/dorm.jpg" alt=""></center>
                  </div>   
            </div>
          </div>
        </div>
