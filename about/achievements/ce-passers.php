...
<title>Certification Exam Passers | About | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="ce-passers.php"><li class="option"><span>Certification Exam Passers</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              ...
              <a href="ce-passers.php"><ul id="active-sbar">Certification Exam Passers</ul></a>
