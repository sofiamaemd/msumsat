...
<title>Facult & Student Awards | About | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="recognitions.php"><li class="option"><span class="option-text" >Recognitions</span></li></a>
              <a href="membership.php"><li class="option"><span class="option-text" >Membership</span></li></a>
              <a href="collaboration.php"><li class="option"><span class="option-text" >Collaboration</span></li></a>
              <a href="let-passers.php"><li class="option"><span class="option-text" >LET Passers</span></li></a>
              <a href="let-pr.php"><li class="option"><span class="option-text" >LET Passing Rate</span></li></a>
              <a href="fs-award.php"><li class="option"><span class="option-text" >Faculty & Student Awards</span></li></a>
              <a href="ce-passers.php"><li class="option"><span class="option-text" >Certification Exam Passers</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../achievements.php"><ul>Overview</ul></a>
              <a href="recognitions.php"><ul>Recognitions</ul></a>
              <a href="membership.php"><ul>Membership</ul></a>
              <a href="collaboration.php"><ul>Collaboration</ul></a>
              <a href="let-passers.php"><ul>LET Passers</ul></a>
              <a href="let-pr.php"><ul>LET Passing Rate</ul></a>
              <a href="fs-award.php"><ul id="active-sbar">Faculty & Student Awards</ul></a>
              <a href="ce-passers.php"><ul>Certification Exam Passers</ul></a>
