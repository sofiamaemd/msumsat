...
<title>History | About | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
                ...
                <a href="history.php"><ul id="active-sbar">History</ul></a>
      ...
      <div class="col-2-con">
        <img id="prospectus-img-size" src="../about-img/msat-history.jpg" alt="">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>History</h1>
            <p>
              The Mindanao State University Maigo School of Arts and Trades (MSU-MSAT) has a rich history that dates back to the 1970s. 
              Here's a brief overview of the school's history:
            </p>
            <p>
