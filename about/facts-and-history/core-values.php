...
<title>VMGO, Core Valuess | About | MSU Maigo</title><meta charset="utf-8">
      ...
      <h2 class="page-header-1">MSU-MSAT Facts & History</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              <a href="../../about.php"><li class="option"><span class="option-text">About</span></li></a>
              <a href="../facts.php"><li class="option"><span class="option-text">Facts</span></li></a>
              <a href="history.php"><li class="option"><span class="option-text" >History</span></li></a>
              <a href="ra5363.php"><li class="option"><span class="option-text" >RA 5363</span></li></a>
              <a href="annual-report.php"><li class="option"><span class="option-text" >Annual Reports</span></li></a>
              <a href="msu-msat-seal.php"><li class="option"><span class="option-text" >MSU MSAT Seal</span></li></a>
              <a href="core-values.php"><li class="option"><span class="option-text" >VMGO, Core Values</span></li></a>
              <a href="university-hymn.php"><li class="option"><span class="option-text" >University Hymn</span></li></a>
              <a href="msu-system.php"><li class="option"><span class="option-text" >MSU Systems</span></li></a>
              <a href="transparency-seal.php"><li class="option"><span class="option-text" >Transparency Seal</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
                <a href="../facts.php"><ul>Facts</ul></a>
                <a href="history.php"><ul>History</ul></a>
                <a href="ra5363.php"><ul>RA 5363</ul></a>
                <a href="annual-report.php"><ul>Annual Reports</ul></a>
                <a href="msu-msat-seal.php"><ul>MSU MSAT Seal</ul></a>
                <a href="core-values.php"><ul id="active-sbar">VMGO, Core Values</ul></a>
                <a href="university-hymn.php"><ul>University Hymn</ul></a>
                <a href="msu-system.php"><ul>MSU System</ul></a>
                <a href="transparency-seal.php"><ul>Transparency Seal</ul></a>
                <a href="../../about.php"><ul id="sbar-back">« Back to About</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="prospectus-img-size" src="../about-img/msu-maigo.JPG" alt="">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>Vision</h1>
            <p>
              MSU-MSAT envisions itself as a leading technical-vocational school in the region, known for its quality education, cutting-edge programs, and commitment to social and economic development.
               We aim to be a catalyst for change and progress in the Maigo area and beyond, by producing graduates who are skilled, knowledgeable, and socially responsible. 
               We envision a future where our graduates are empowered to become leaders and agents of change in their communities, and where our school is recognized as a center of excellence in technical-vocational education and training.
            </p>
            <h1>Mission</h1>
            <p>
              The Mindanao State University Maigo School of Arts and Trades (MSU-MSAT) is committed to providing high-quality technical-vocational education and training to students in the Maigo area and surrounding communities. 
              We aim to produce skilled and competent graduates who can contribute to the development of the region and the country as a whole. 
              We strive to promote excellence, innovation, and social responsibility in all our programs and services.
            </p>
            <h1>Core Values</h1>
            <p>
              The Mindanao State University Maigo School of Arts and Trades (MSU-MSAT) upholds core values that reflect its commitment to providing high-quality technical-vocational education and training, as well as promoting social and economic development in the Maigo area and surrounding communities. 
              Here are the core values of MSU-MSAT:
            </p>
            <p>
              Excellence - MSU-MSAT values excellence in all its programs and services. 
              We strive to provide the highest quality education and training to our students, and to promote excellence in research, innovation, and community service.
            </p>
            <p>
              Integrity - MSU-MSAT upholds the highest standards of ethical conduct, transparency, and accountability. 
              We believe in honesty, fairness, and respect for others, and we expect our students, faculty, and staff to embody these values in all their interactions.
            </p>
            <p>
              Service - MSU-MSAT is committed to using education as a means to promote social and economic development in the Maigo area and beyond. 
              We believe in the power of education to transform lives and communities, and we encourage our students to use their skills and knowledge to serve others and make a positive impact in the world.
            </p>
            <p>
              Innovation - MSU-MSAT values innovation and creativity in all its programs and services. 
              We encourage our students, faculty, and staff to think outside the box, explore new ideas, and develop cutting-edge solutions to the challenges facing our society.
            </p>
            <p>
              Social Responsibility - MSU-MSAT believes in the importance of social responsibility and community engagement. 
              We strive to be a responsible and responsive member of the Maigo community and the larger society, and we encourage our students to become socially responsible and active citizens who are committed to making a positive difference in the world.
            </p>
            <div class="tps-dsgn con-fix no-padding">
              <h2>Objectives</h2>
                <div>
                  <ul class="column">
                      <ul>
        ...
        <div class="col-2-3" id="responsive">
          <div class="col-2-subp">
            ...
            <div class="col-3-links">
              <p><a href="../../admissions.php">Admission</a></p>
              <p><a href="../../admissions/flowchart.php">Enrolment Flowchart</a></p>
              <p><a href="../../admissions/requirements.php">Requirements</a></p>
              <p><a href="../../offices/academics/secondary-office.php">Secondary Office</a></p>
              <p><a href="../../academics/programs-offered/secondary-education.php">Secondary Programs</a></p>
            </div>
          </div>
        </div>
      </div>
