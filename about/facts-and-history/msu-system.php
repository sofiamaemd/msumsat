...
<title>MSU System | About | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
                ...
                <a href="msu-system.php"><ul id="active-sbar">MSU System</ul></a>
                <a href="transparency-seal.php"><ul>Transparency Seal</ul></a>
                <a href="../../about.php"><ul id="sbar-back">« Back to About</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="prospectus-img-size" src="../about-img/msu-system-img.jpg" alt="">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>MSU System</h1>
            <p>
              The Mindanao State University System is an important institution in the Philippines, and has played a significant role in promoting education, research, and innovation in Mindanao.
               Its campuses continue to produce graduates who are making important contributions to the development and progress of the region and the country as a whole.
            </p>
            <div class="tps-dsgn con-fix no-padding">
              <h2>Universites</h2>
                <div>
                  <ul class="column">
                      <ul>
                        <li><a href="www.msumain.edu.ph">MSU Main - Marawi City</a></li>
                        <li><a href="www.msuiit.edu.ph">MSU-IIT - Iligan City</a></li>
                        <li><a href="www.msugensan.edu.ph">MSU Gensan - General Santos City</a></li>
                        <li><a href="https://msubuug.edu.ph/">MSU Buug, Zamboanga Sibugay</a></li>
                        <li><a href="https://www.msulnac.edu.ph/">MSU LNAC</a></li>
                        <li><a href="https://www.facebook.com/LNCAT/">MSU LNCAT</a></li>
                      </ul>
                  </ul>
                  <ul class="column">
                      <ul>
                        <li><a href="www.msunaawan.edu.ph">MSU Naawan - Naawan Misamis Oriental </a></li>
                        <li><a href="https://msutawi-tawi.edu.ph/">MSU Tawi-Tawi - Sanga-Sanga, Bongao, Tawi-Tawi</a></li>
