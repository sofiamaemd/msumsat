...
<title>University Hymn | About | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
                ...
                <a href="university-hymn.php"><ul id="active-sbar">University Hymn</ul></a>
      ...
      <div class="col-2-con">
        <div class="col-2-2" id="responsive">
          ...
          <div class="col-1-subp">
            <div class="images audio-con">
              <img src="../../images/white-msat-logo.png" alt="Image 2"><br>
              <button id="playButton" class="animated"><span id="playIcon">&#9658;</span><span id="pauseIcon">&#10074;&#10074;</span></button>
              <audio id="audioPlayer" src="../../audio/video.op.mp3"></audio>
              <a>Himno ng Pamantasan</a>
            </div>
            <div class="u-hymn">
              <h1>University Hymn</h1>
             <p>
              Silahis ang katulad mong<br>
              nagsabog ng liwanag
              </p>
              <p>
               Ng pag-asa't hangarin<br>
               ng pag-unlad.
              </p>
              <p>
               Ang pook ng Mindanao<br>
               tinanglaw at pinalad,
              </p>
              <p>
               Nang ika'y isilang<br>
              ...
              <p>
               Ang buhay at pag-ibig<br>
               sa kanya'y iaalay;
              </p>
              <p>
               Saan man naroroon<br>
               ay bigyang karangalan,
              </p>
              <p>
               Dakilang paaralan<br>
