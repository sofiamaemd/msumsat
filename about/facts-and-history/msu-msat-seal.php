...
<title>MSU-MSAT Seal | About | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
                ...
                <a href="msu-msat-seal.php"><ul id="active-sbar">MSU MSAT Seal</ul></a>
      ...
      <div class="col-2-con">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp bold-span">
            <style>
              #img-min-size{width: 40%;}
            </style>

            <div>
              <center><img src="../../images/white-msat-logo.png" alt="" id="img-min-size"></center>
            </div>
            <h1>Seal of MSU-MSAT</h1>
            <p>
              The <span>Seal</span> of the Mindanao State University-Maigo School of Arts and Trades shows a gear encircling 
              the Mindanao State University seal which: 
            </p>
            <p>
              Created by <span>Anonymous Student</span> with a very good sense of culture and vision. The <span>three rays</span> on top 
              stand for the <span>Mindanao</span>, <span>Sulu</span> and <span>Palawan</span> (MINSUPALA) regions which were the main thrust of MSU at 
              its inception. The <span>lamp</span> in the middle sigifies the light with which to guide the people in their 
              quest for knowledge. Finally, the <span>fish</span> and the "<span>okir</span>" symbols around the lamp along with the color 
              scheme represent the unique and impressive culture of the Maranaos in the area surrounding the 
              Mindanao State University. (MSU Main Campus - Marawi)
            </p>
            <p>
              The <span>gear</span>, symbolizes industrial technology as the focal program of the campus. Furthermore, it 
              depicts interdependence and advancement in knowledge and skills among students.<span> Year 2001</span>, 
              indicates the time of the campus' integration to the Mindanao State University System.
            </p>
          </div>
        </div>
        <div class="col-2-3">
