...
<title>Facts | About | MSU Maigo</title><meta charset="utf-8">
...
<link rel='stylesheet' href='https://cdn.jsdelivr.net/npm/bootstrap-icons@1.7.2/font/bootstrap-icons.css'><link href='https://fonts.googleapis.com/css?family=Source Sans Pro'>
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="facts-and-history/history.php"><li class="option"><span class="option-text" >History</span></li></a>
              <a href="facts-and-history/ra5363.php"><li class="option"><span class="option-text" >RA 5363</span></li></a>
              <a href="facts-and-history/annual-report.php"><li class="option"><span class="option-text" >Annual Reports</span></li></a>
              <a href="facts-and-history/msu-msat-seal.php"><li class="option"><span class="option-text" >MSU MSAT Seal</span></li></a>
              <a href="facts-and-history/core-values.php"><li class="option"><span class="option-text" >VMGO, Core Values</span></li></a>
              <a href="facts-and-history/university-hymn.php"><li class="option"><span class="option-text" >University Hymn</span></li></a>
              <a href="facts-and-history/msu-system.php"><li class="option"><span class="option-text" >MSU Systems</span></li></a>
              <a href="facts-and-history/transparency-seal.php"><li class="option"><span class="option-text" >Transparency Seal</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
                <a href="facts.php"><ul id="active-sbar">Facts</ul></a>
                <a href="facts-and-history/history.php"><ul>History</ul></a>
                <a href="facts-and-history/ra5363.php"><ul>RA 5363</ul></a>
                <a href="facts-and-history/annual-report.php"><ul>Annual Reports</ul></a>
                <a href="facts-and-history/msu-msat-seal.php"><ul>MSU MSAT Seal</ul></a>
                <a href="facts-and-history/core-values.php"><ul>VMGO, Core Values</ul></a>
                <a href="facts-and-history/university-hymn.php"><ul>University Hymn</ul></a>
                <a href="facts-and-history/msu-system.php"><ul>MSU System</ul></a>
                <a href="facts-and-history/transparency-seal.php"><ul>Transparency Seal</ul></a>
                <a href="../about.php"><ul id="sbar-back">« Back to About</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="prospectus-img-size" src="../about/about-img/msat-pic.jpg" alt="">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>Facts</h1>
            <p>
              MSU-MSAT is a public technical-vocational institution located in Maigo, Lanao del Norte, Philippines. 
              It is a satellite campus of the Mindanao State University (MSU) system.
            </p>
            <p>
              The school was established in 1974 as the Maigo National Trade School (MNTS), and was later integrated into the MSU system in 1978 as the MSU-Maigo School of Arts and Trades.
            </p>
            <p>
              MSU-MSAT offers certificate and diploma programs in various technical and vocational fields, such as automotive technology, electrical technology, welding technology, and garment technology.
            </p>
            <p>
              The school also has a strong emphasis on entrepreneurship education, with courses on small business management and product development.
            </p>
            <p>
              MSU-MSAT is committed to providing quality education to the people of Maigo and nearby communities, with a focus on producing highly skilled and competent graduates who can contribute to the development of their respective industries and communities.
            </p>
            <p>
              The school has a modern and well-equipped campus, with facilities such as a library, computer laboratory, and workshops for hands-on training.
            </p>
            <p>
              MSU-MSAT is part of the Mindanao State University System, which is one of the largest and most prestigious higher education institutions in the Philippines, with campuses throughout Mindanao and a reputation for academic excellence and social relevance.
            </p>
          </div>
        </div>
