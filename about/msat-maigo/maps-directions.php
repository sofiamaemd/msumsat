        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
                ...
                <a href="maps-directions.phpl"><li class="option"><span class="option-text">Maps & Directions</span></li></a>
              </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
                <a href="../msat-maigo.php"><ul>Overview</ul></a>
                <a href="maps-directions.php"><ul id="active-sbar">Maps & Directions</ul></a>
                <a  href="../../about.php"><ul id="sbar-back">« Back to About</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <iframe id="prospectus-img-size" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15797.78702561431!2d123.9604738!3d8.1576627!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3255afe12dfa8889%3A0xc0ab7b6479b77102!2smaigo%20lanao%20del%20norte!5e0!3m2!1sen!2sph!4v1684984597820!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
