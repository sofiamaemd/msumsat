...
<title>Achievements | About | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="achievements.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="achievements/recognitions.php"><li class="option"><span class="option-text">Recognitions</span></li></a>
              <a href="chievements/membership.php"><li class="option"><span class="option-text">Membership</span></li></a>
              <a href="achievements/collaboration.php"><li class="option"><span class="option-text">Collaboration</span></li></a>
              <a href="achievements/let-passers.php"><li class="option"><span class="option-text">LET Passers</span></li></a>
              <a href="achievements/let-pr.php"><li class="option"><span class="option-text">LET Passing Rate</span></li></a>
              <a href="achievements/fs-award.php"><li class="option"><span class="option-text">Faculty & Student Awards</span></li></a>
              <a href="achievements/ce-passers.php"><li class="option"><span class="option-text">Certification Exam Passers</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="achievements.php"><ul id="active-sbar">Overview</ul></a>
              <a href="achievements/recognitions.php"><ul>Recognitions</ul></a>
              <a href="achievements/membership.php"><ul>Membership</ul></a>
              <a href="achievements/collaboration.php"><ul>Collaboration</ul></a>
              <a href="achievements/let-passers.php"><ul>LET Passers</ul></a>
              <a href="achievements/let-pr.php"><ul>LET Passing Rate</ul></a>
              <a href="achievements/fs-award.php"><ul>Faculty & Student Awards</ul></a>
              <a href="achievements/ce-passers.php"><ul>Certification Exam Passers</ul></a>
