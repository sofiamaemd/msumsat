...
<title>Maigo | About | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">Maigo</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="msat-maigo.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="msat-maigo/maps-directions.phpl"><li class="option"><span class="option-text">Maps & Directions</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="msat-maigo.php"><ul id="active-sbar">Overview</ul></a>
              <a href="msat-maigo/maps-directions.php"><ul>Maps & Directions</ul></a>
              <a  href="../about.php"><ul id="sbar-back">« Back to About</ul></a>
            </div>
      </div>
      <div class="col-2-con">
        <img id="prospectus-img-size" src="about-img/maigo-img.jpg" alt="">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>Overview</h1>
            <p>
              Maigo, Lanao del Norte: A vibrant municipality nestled amidst scenic landscapes, Maigo offers a unique blend 
              of cultural heritage, breathtaking views, and warm hospitality. With abundant natural resources, outdoor 
              activities, and a rich cultural tapestry, Maigo captivates visitors with its beauty and charm. 
              The municipality's progressive outlook and commitment to sustainable development make it an emerging 
              hub for agriculture, aquaculture, and eco-tourism. Experience the wonders of Maigo—a captivating 
              destination in Northern Lanao del Norte, Philippines.
            </p>
          </div>
        </div>
