...
<title>Information | About | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="../about/information/maps-and-directions.php"><li class="option"><span class="option-text" >Maps & Directions</span></li></a>
              <a href="../about/information/facilities.php"><li class="option"><span class="option-text" >Facilities</span></li></a>
              <a href="../about/information/gallery.php"><li class="option"><span class="option-text" >Gallery</span></li></a>
              <a href="../about/information/accommodation.php"><li class="option"><span class="option-text" >Accommodation</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="information.php"><ul id="active-sbar">Overview</ul></a>
              <a href="information/maps-and-directions.php"><ul>Maps & Directions</ul></a>
              <a href="information/facilities.php"><ul>Facilities</ul></a>
              <a href="information/gallery.php"><ul>Gallery</ul></a>
              <a href="information/accommodation.php"><ul>Accommodation</ul></a>
              <a href="../about.php"><ul id="sbar-back">« Back to About</ul></a>
            </div>
      </div>
      <div class="col-2-con">
      <img id="prospectus-img-size" src="about-img/info-img.jpg" alt="">
