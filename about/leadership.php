...
<title>Leadership | About | MSU Maigo</title><meta charset="utf-8">
...
<div class="body-outer-wrapper">
  <div class="body-inner-wrapper">
    <main>
      <h2 class="page-header-1">MSU-MSAT Leadership</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="leadership.php"><li class="option"><span class="option-text">Welcome</span></li></a>
              <a href="../offices/office-of-the-campus-head.php"><li class="option"><span class="option-text">Office of the Campus Head</span></li></a>
              <a href="../home/campus-officials.php"><li class="option"><span class="option-text">Campus Officials</span></li></a>
              <a href="department-heads.php"><li class="option"><span class="option-text">Department Heads</span></li></a>
              <a href="academic-units.php"><li class="option"><span class="option-text">Heads of Academic Units</span></li></a>
              <a href="research-and-extension-units.php"><li class="option"><span class="option-text">Heads of Research & Extension Units</span></li></a>
              <a href="administration-and-finance-units.php"><li class="option"><span class="option-text">Heads of Administration & Finance Units</span></li></a>
              <a href="planning-and-development-units.php"><li class="option"><span class="option-text">Heads of Planning and Development Units</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
                <a href="leadership.php"><ul id="active-sbar">Welcome</ul></a>
                <a href="../offices/office-of-the-campus-head.php"><ul>Office of the Campus Head</ul></a>
                <a href="../home/campus-officials.php"><ul>Campus Officials</ul></a>
                <a href="../home/campus-officials/campus-overall-directory/department-heads.php"><ul>Department Heads</ul></a>
                <a href="leadership/academic-units.php"><ul>Heads of Academic Units</ul></a>
                <a href="leadership/semi-academic-units.php"><ul>Heads of Semi-Academic Units</ul></a>
                <a href="leadership/research-and-extension-units.php"><ul>Heads of Research & Extension Units</ul></a>
                <a href="leadership/administration-and-finance-units.php"><ul>Heads of Administration & Finance Units</ul></a>
                <a href="leadership/planning-and-development-units.php"><ul>Heads of Planning and Development Units</ul></a>
      ...
      <div class="col-2-con">
        <div class="col-2-2" id="responsive">
          ...
          <img class="max-img" src="about-img/underconstruction.jpg" alt="">
          </div>
        </div>
