...
<title>Rights of Students | Admissions | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="ros.php"><li class="option"><span class="option-text">Rights of Students</span></li></a>
              <a href="downloads.php"><li class="option"><span class="option-text">Downloads</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../requirements.php"><ul>General Admission Requirements</ul></a>
              <a href="ros.php"><ul id="active-sbar">Rights of Students</ul></a>
