...
<title>SASE Guidelines & Results | Admissions | MSU Maigo</title><meta charset="utf-8">
        ...
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              ...
              <a href="sase-guidelines-results.php"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="sase-guidelines-results/sase-application-guidelines.php"><li class="option"><span class="option-text">SASE Application Guidelines</span></li></a>
              <a href="sase-guidelines-results/sase-results.php"><li class="option"><span class="option-text">SASE Results</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="sase-guidelines-results.php"><ul id="active-sbar">Overview</ul></a>   
              <a href="sase-guidelines-results/sase-application-guidelines.php"><ul>SASE Application Guidelines</ul></a>
              <a href="sase-guidelines-results/sase-results.php"><ul>SASE Results</ul></a>
      ...
      <div class="col-2-con">
        ...
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <h1>Overview</h1>
            <p>
              Schools are ignificant entities within a university, as they are responsible for providing academic 
              programs and courses in different fields of study. From a student's perspective, schools 
              serve as a hub for finding courses and programs that align with their academic interests 
              and career aspirations.
            </p>
            <p>
              Every school within the university is focused on a specific subject area or academic discipline, 
              such as business, engineering, education, arts, or sciences. Moreover, schools 
              may also contain multiple departments or programs that provide more specialized coursework in a 
              particular field.
            </p>
            <p>
              Studying at a university with schools offers students the chance to participate in research and 
              scholarly activities related to their fields of study. Student, may have an opportunity to 
              collaborate with faculty members and other scholars on research projects that explore novel 
              concepts and advance knowledge in any field.
            </p>
            <p>
              Schools in a university are vital elements of the academic journey, providing 
              students with specialized education and training in their chosen areas of study. 
              Additionally, schools cultivate a dynamic intellectual community that promotes cooperation and innovation.
            </p>
          </div>
        </div>
