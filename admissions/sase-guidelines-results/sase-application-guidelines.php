...
<title>SASE Application Guidelines | Admissions | MSU Maigo</title><meta charset="utf-8">
      ...
      <h2 class="page-header-1">SASE Guidelines & Results</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              <a href="../../ad.php"><li class="option"><span class="option-text">Admissions</span></li></a>
              <a href="../sase-guidelines-results.htm"><li class="option"><span class="option-text">Overview</span></li></a>
              <a href="sase-application-guidelines.php"><li class="option"><span class="option-text">SASE Application Guidelines</span></li></a>
              <a href="sase-results.php"><li class="option"><span class="option-text">SASE Results</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
            <div class="sidebar-col">
              <a href="../sase-guidelines-results.php"><ul>Overview</ul></a>   
              <a href="sase-application-guidelines.php"><ul id="active-sbar">SASE Application Guidelines</ul></a>
              <a href="sase-results.php"><ul>SASE Results</ul></a>
