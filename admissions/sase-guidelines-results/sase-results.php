...
<title>SASE Results | Admissions | MSU Maigo</title><meta charset="utf-8">
    ...
    <main>
      <h2 class="page-header-1">SASE Guidelines & Results</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              <a href="../../admissions.php"><li class="option"><span class="option-text">Admissions</span></li></a>
      ...
      <div class="col-1-con first">
            <div class="sidebar-col">
              ...
              <a href="sase-application-guidelines.php"><ul>SASE Application Guidelines</ul></a>
              <a href="sase-results.php"><ul id="active-sbar">SASE Results</ul></a>
