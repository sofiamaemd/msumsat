...
<title>Requirements | Admissions | MSU Maigo</title><meta charset="utf-8">
      ...
      <h2 class="page-header-1">Requirements</h2>
        <div id="submenu" class="select-menu">
          <h2 id="page-header"><div class="select-btn burger-btn"  onclick="myBurger(this)">
            ...
            <ul class="options">
              <a href="../admissions.php"><li class="option"><span class="option-text">Admission</span></li></a>
              <a href="requirements.php"><li class="option"><span class="option-text">General Admission Requirements</span></li></a>
              <a href="requirements/ros.php"><li class="option"><span class="option-text">Rights of Students</span></li></a>
              <a href="requirements/downloads.php"><li class="option"><span class="option-text">Downloads</span></li></a>
            </ul>
        </div>
      <div class="col-1-con first">
        <div class="sidebar-col">
          <a href="#" id="gar-dropdown-btn">
            <ul id="active-sbar">General Admission Requirements<span class="icon fa fa-angle-double-down"></span></ul>
          </a>
          <ul class="dropdown" id="gar-dropdown">
            <li><a href="#section1" onclick="scrollToTarget('#section1')">Undergraduate Programs</a></li>
            <li><a href="#section2" onclick="scrollToTarget('#section2')">Graduate Programs</a></li>
            <li><a href="#section3" onclick="scrollToTarget('#section3')">Secondary Programs</a></li>
            <li><a href="#section4" onclick="scrollToTarget('#section4')">Transferee</a></li>
          </ul>
          <a href="requirements/ros.php"><ul>Rights of Students</ul></a>
          <a href="requirements/downloads.php"><ul>Downloads</ul></a>
          <a href="../admissions.php"><ul id="sbar-back">« Back to Admission</ul></a>
        </div>
      </div>
      <div class="col-2-con">
        <div class="col-2-2" id="responsive">
          <div class="col-1-subp">
            <div class="pg-req-design">
              <h1 id="section1">Undergraduate Programs (<span>Freshmen</span>)</h1>
              <ul>
                <li><a>System Admission and Scholarship Examination (SASE) / College Entrance Test (CET) or College Bound Program (CBP) Report</a></li>
                <li><a>Senior High School Report Card/Form: 138A (Original)</a></li>
                <li><a>Certificate of Good Moral Character from Senior High School Principal</a></li>
                <li><a>Birth Certificate (PSA authenticated)</a></li>
                <li><a>Medical Certificate from the Campus Medical Services</a></li>
                <li><a>Four (4) pcs "2x2" photo with name tag</a></li>
                <li><a>One (1) long brown with plastic transparent envelope</a></li>
              </ul>
              <h1 id="section2">Graduate Programs</h1>
              <h2>Certificate in Professional Teaching (CPrT)</h2>
              <ul>
                <li><a>Honorable Dismissial/Transfer Certificate</a></li>
                <li><a>Transcript of Records</a></li>
                <li><a>Certificate of Good Moral Character</a></li>
                <li><a>Birth Certificate (PSA authenticated)</a></li>
                <li><a>Four (4) pcs "2x2" photo with name tag</a></li>
                <li><a>Medical Certificate</a></li>
              </ul>
              <h3>Master's Degree Programs</h3>
              <ul>
                <li><a>Qualifying Examination administered by Graduate School</a></li>
                <li><a>Honorable Dismissial/Transfer Certificate</a></li>
                <li><a>Transcript of Records</a></li>
                <li><a>Birth Certificate (PSA authenticated)</a></li>
                <li><a>Marriage Certificate (PSA-SECPA authenticated)</a></li>
                <li><a>Four (4) pcs "2x2" photo with name tag</a></li>
                <li><a>One (1) long brown with plastic transparent envelope</a></li>
              </ul>
              <h1 id="section3">Secondary Programs</h1>
              <h2>Junior High School</h2>
              <ul>
                <li><a>Grade 7 Entrance Exam Result</a></li>
                <li><a>Report Card</a></li>
                <li><a>Pre-Enrollment Form (Photocopy)</a></li>
                <li><a>Certificate of Good Moral Character (Original & Photocopy)</a></li>
                <li><a>PSA Birth Certificate (Two Photocopies)</a></li>
                <li><a>Four (4) pcs "2x2" photo with name tag</a></li>
                <li><a>One (1) long brown with plastic transparent envelope</a></li>
              </ul>
              <h3>Senior High School</h3>
              <ul>
                <li><a>Senior High School Entrance Exam Result</a></li>
                <li><a>Junior High School Report Card</a></li>
                <li><a>QVR Certification (for non MSU-MSAT Completers Only)</a></li>
                <li><a>Pre-Enrollment Form (Photocopy)</a></li>
                <li><a>Students Information Form (for non MSU_MSAT Completers Only)</a></li>
                <li><a>Certificate of Good Moral Character (Original & Photocopy)</a></li>
                <li><a>PSA Birth Certificate (Two Photocopies)</a></li>
                <li><a>Four (4) pcs "2x2" photo with name tag</a></li>
                <li><a>One (1) long brown with plastic transparent envelope</a></li>
              </ul>
              <h1 id="section4">Transferee (<span>Continuee</span>)</h1>
              <ul>
                <li><a>Honorable Dismissial/Transfer Certificate</a></li>
                <li><a>Transcript of Records/Evaluation of Gradres (signed by the Registrar)</a></li>
                <li><a>Certificate of Good Moral Character</a></li>
                <li><a>Birth Certificate (PSA authenticated)</a></li>
                <li><a>SASE/CET Report of Rating (for transferees from non-MSU Campuses)</a></li>
                <li><a>Medical Certificate</a></li>
                <li><a>Four (4) pcs "2x2" photo with name tag</a></li>
                <li><a>One (1) long brown with plastic transparent envelope</a></li>
              </ul>
...
<script>
var garDropdownBtn = document.getElementById("gar-dropdown-btn");
var garDropdown = document.getElementById("gar-dropdown");
var garIcon = document.querySelector("#gar-dropdown-btn .icon");

garDropdownBtn.addEventListener("click", function(e) {
  e.preventDefault();
  garDropdown.classList.toggle("show");
  garIcon.classList.toggle("active");
});
</script>
    </body>
</html>